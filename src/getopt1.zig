...
pub extern fn getopt(argc: c_int, argv: [*c]const [*c]u8, shortopts: [*c]const u8) c_int;
...
pub const GETOPT_INTERFACE_VERSION = 2;
pub const _GNU_VERSIONS_H = 1;
pub const _GNU_OBSTACK_INTERFACE_VERSION = 1;
pub const _GNU_REGEX_INTERFACE_VERSION = 1;
pub const _GNU_GLOB_INTERFACE_VERSION = 2;
pub const _GNU_GETOPT_INTERFACE_VERSION = 2;
