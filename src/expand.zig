...
var variable_buffer_length: c_ulonglong = undefined;
pub var variable_buffer: ?[]c_char = null;
...
pub fn initialize_variable_output() []c_char {
    // If we don't have a variable output buffer yet, get one.

    if (variable_buffer == null) {
        variable_buffer_length = 200;
        variable_buffer = misc.xmalloc(c_char, variable_buffer_length);
        variable_buffer.?[0] = 0;
    }
