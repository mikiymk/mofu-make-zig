...
pub export fn expand_argument(arg_str: [*c]const u8, arg_end: [*c]const u8) [*c]u8 {
    ...
    if (!(end != null) or (@as(c_int, @bitCast(@as(c_uint, end.*))) == @as(c_int, '\x00'))) return allocated_variable_expand_for_file(str, @as(?*struct_file, @ptrFromInt(@as(c_int, 0))));
    ...
    r = allocated_variable_expand_for_file(tmp, @as(?*struct_file, @ptrFromInt(@as(c_int, 0))));
                        ...
                        if (colon != null) {
                            ...
                            if (subst_end == null) {
                                ...
                                if ((v != null) and (@as(c_int, @bitCast(@as(c_uint, v.*.value.*))) != @as(c_int, '\x00'))) {
                                    ...
                                    _ = &rpercent;
                                    var value: [*c]u8 = if (@as(c_int, @bitCast(v.*.recursive)) != 0) recursively_expand_for_file(v, null) else v.*.value;
                                    _ = &value;
