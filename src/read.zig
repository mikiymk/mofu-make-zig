...
pub export fn construct_include_path(arg_arg_dirs: [*c][*c]const u8) void {
    ...
    if (arg_dirs != null) while (arg_dirs.* != null) {
        ...
        if ((e == 0) and ((stbuf.st_mode & @as(__mode_t, 61440)) == @as(__mode_t, 16384))) {
            var len: usize = strlen(dir);
            while ((len > @as(usize, 1)) and (@as(c_int, @bitCast(@as(c_uint, dir[len -% @as(usize, 1)]))) == @as(c_int, '/'))) {
                len -%= 1;
            }
            if (len > max_incl_len) {
                max_incl_len = len;
    ...
    if (!(disable != 0)) {
        {
            ...
            while (cpp.* != null) : (cpp += 1) {
                ...
                if ((e == 0) and ((stbuf.st_mode & @as(__mode_t, 61440)) == @as(__mode_t, 16384))) {
                    ...
                    while ((len > @as(usize, 1)) and (@as(c_int, @bitCast(@as(c_uint, cpp.*[len -% @as(usize, 1)]))) == @as(c_int, '/'))) {
                        len -%= 1;
                    }
                    if (len > max_incl_len) {
                        max_incl_len = len;
    ...
    dirs[idx] = null;
    _ = do_variable_definition(@as([*c]floc, @ptrFromInt(0)), ".INCLUDE_DIRS", "", @as(c_uint, @bitCast(o_default)), @as(c_uint, @bitCast(f_simple)), 0);
    {
        cpp = dirs;
        while (cpp.* != null) : (cpp += 1) {
            _ = do_variable_definition(@as([*c]floc, @ptrFromInt(0)), ".INCLUDE_DIRS", cpp.*, @as(c_uint, @bitCast(o_default)), @as(c_uint, @bitCast(f_append)), 0);
        }
    }
...
pub export fn parse_file_seq(arg_stringp: [*c][*c]u8, arg_size: usize, arg_stopmap: c_int, arg_prefix: [*c]const u8, arg_flags: c_int) ?*anyopaque {
    ...
    }
    {
        ...
        var l: usize = strlen(stringp.*) +% ulong;
    ...
    while (true) {
        ...
        if ((@as(c_int, @bitCast(@as(c_uint, stopchar_map[@as(u8, @bitCast(p.*))]))) & stopmap) != 0) break;
        s = p;
        p = find_map_unquote(p, findmap);
        if (!(p != null)) {
            p = s + strlen(s);
        }
        if ((((flags & 64) != 0) and (@as(c_ulong, @bitCast(@divExact(@as(c_long, @bitCast(@intFromPtr(p) -% @intFromPtr(s))), @sizeOf(u8)))) == (@sizeOf([6]u8) -% ulong))) and (memcmp(@as(?*const anyopaque, @ptrCast(s)), @as(?*const anyopaque, @ptrCast(".WAIT")), @sizeOf([6]u8) -% ulong) == 0)) {
            found_wait = 1;
            continue;
        }
        if (!((flags & 1) != 0)) while (((@divExact(@as(c_long, @bitCast(@intFromPtr(p) -% @intFromPtr(s))), @sizeOf(u8)) > long) and (@as(c_int, @bitCast(@as(c_uint, s[0]))) == @as(c_int, '.'))) and (@as(c_int, @bitCast(@as(c_uint, s[1]))) == @as(c_int, '/'))) {
            s += @as(usize, @bitCast(@as(isize, 2)));
        ...
        if (((!((flags & 2) != 0) and (tp == tmpbuf.static)) and (@as(c_int, @bitCast(@as(c_uint, tp[0]))) != @as(c_int, '('))) and (@as(c_int, @bitCast(@as(c_uint, tp[nlen -% @as(usize, 1)]))) != @as(c_int, ')'))) {
            var n: [*c]u8 = strchr(tp, @as(c_int, '('));
            if (n != null) {
                var e: [*c]const u8 = p;
                while (true) {
                    var o: [*c]const u8 = e;
                    while ((@as(c_int, @bitCast(@as(c_uint, stopchar_map[@as(u8, @bitCast(e.*))]))) & (2 | 4)) != 0) {
                        e += 1;
                    }
                    while (!((@as(c_int, @bitCast(@as(c_uint, stopchar_map[@as(u8, @bitCast(e.*))]))) & findmap) != 0)) {
                        e += 1;
                    }
                    if (e == o) break;
                    if (@as(c_int, @bitCast(@as(c_uint, (blk: {
                        ...
                        nlen -%= @as(usize, @bitCast(@divExact(@as(c_long, @bitCast(@intFromPtr(n + @as(usize, @bitCast(@as(isize, 1)))) -% @intFromPtr(tp))), @sizeOf(u8))));
                        tp = n + @as(usize, @bitCast(@as(isize, 1)));
                        break;
                    }
        ...
        if (tp > tmpbuf.static) {
            if (@as(c_int, @bitCast(@as(c_uint, tp[nlen -% @as(usize, 1)]))) == @as(c_int, ')')) {
                tp = tmpbuf.static;
                if (nlen == @as(usize, 1)) continue;
            } else {
                tp[
                    blk: {
                        const ref = &nlen;
        ...
        if ((flags & 4) != 0) {
            while (true) {
                ...
                var __n: [*c]const u8 = concat(uint, prefix, tmpbuf.static);
        ...
        if (!((flags & 2) != 0) and (ar_name(name) != 0)) {
            ar_parse_name(name, &arname, &memname);
            name = arname;
        }
        if (!((flags & 8) != 0) and (strpbrk(name, "?*[") == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(0))))))) {
            globme = 0;
            tot = 1;
            nlist = &name;
        } else {
            while (true) {
                switch (glob(name, 1 << 9, null, &gl)) {
                    1 => {
                        out_of_memory();
        ...
        }
        {
            ...
            while (i < tot) : (i += 1) if (memname != null) {
                ...
                if (!(found != null)) {
                    while (true) {
                        var _ns: [*c]struct_nameseq = @as([*c]struct_nameseq, @ptrCast(@alignCast(xcalloc(size))));
                        var __n: [*c]const u8 = concat(uint, prefix, (blk: {
                            const tmp = i;
                            if (tmp >= 0) break :blk nlist + @as(usize, @intCast(tmp)) else break :blk nlist - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*, "(", memname, ")");
                        _ns.*.name = if (cachep != 0) strcache_add(__n) else @as([*c]const u8, @ptrCast(@alignCast(xstrdup(__n))));
                    ...
                    while (true) {
                        if (!(cachep != 0)) {
                            found.*.name = xstrdup(concat(uint, prefix, name));
                        } else if (prefix != null) {
                            found.*.name = strcache_add(concat(uint, prefix, name));
                        }
...
pub export fn tilde_expand(arg_name: [*c]const u8) [*c]u8 {
    ...
    if ((@as(c_int, @bitCast(@as(c_uint, name[1]))) == @as(c_int, '/')) or (@as(c_int, @bitCast(@as(c_uint, name[1]))) == @as(c_int, '\x00'))) {
        ...
        var is_variable: c_int = undefined;
        {
            ...
            home_dir = allocated_variable_expand_for_file("$(HOME)", @as(?*struct_file, @ptrFromInt(0)));
        ...
        if (home_dir != null) {
            var new: [*c]u8 = xstrdup(concat(uint, home_dir, name + @as(usize, @bitCast(@as(isize, 1)))));
            if (is_variable != 0) {
                free(@as(?*anyopaque, @ptrCast(home_dir)));
            }
            return new;
        ...
        var userend: [*c]u8 = strchr(name + @as(usize, @bitCast(@as(isize, 1))), @as(c_int, '/'));
        if (userend != null) {
            userend.* = '\x00';
        }
        pwent = getpwnam(name + @as(usize, @bitCast(@as(isize, 1))));
        if (pwent != null) {
            if (userend == null) return xstrdup(pwent.*.pw_dir);
            userend.* = '/';
            return xstrdup(concat(uint, pwent.*.pw_dir, "/", userend + @as(usize, @bitCast(@as(isize, 1)))));
...
pub export fn read_all_makefiles(arg_makefiles: [*c][*c]const u8) ?*struct_goaldep {
    ...
    _ = define_variable_in_set("MAKEFILE_LIST", @sizeOf([14]u8) -% ulong, "", @as(c_uint, @bitCast(o_file)), 0, current_variable_set_list.*.set, @as([*c]floc, @ptrFromInt(0)));
    while (true) {
        if ((1 & db_level) != 0) {
    ...
    }
    {
        ...
        value = allocated_variable_expand_for_file("$(MAKEFILES)", @as(?*struct_file, @ptrFromInt(0)));
        p = value;
        while ((blk: {
            ...
            _ = eval_makefile(strcache_add(name), @as(c_ushort, @bitCast(@as(c_short, @truncate(((1 << 0) | (1 << 1)) | (1 << 2))))));
        }
        free(@as(?*anyopaque, @ptrCast(value)));
    }
    if (makefiles != null) while (makefiles.* != null) {
        var d: ?*struct_goaldep = eval_makefile(makefiles.*, @as(c_ushort, @bitCast(@as(c_short, @truncate(0)))));
    ...
    if (num_makefiles == uint) {
        ...
        if (p.* != null) {
            _ = eval_makefile(p.*, @as(c_ushort, @bitCast(@as(c_short, @truncate(0)))));
            if (__errno_location().* != 0) {
                perror_with_name("", p.*);
            }
        } else {
...
pub fn eval_makefile(arg_filename: [*c]const u8, arg_flags: c_ushort) callconv(.C) ?*struct_goaldep {
    ...
    if ((2 & db_level) != 0) {
        ...
        if ((@as(c_int, @bitCast(@as(c_uint, flags))) & (1 << 0)) != 0) {
            _ = printf(gettext(" (no default goal)"));
        }
        if ((@as(c_int, @bitCast(@as(c_uint, flags))) & (1 << 1)) != 0) {
            _ = printf(gettext(" (search path)"));
        }
        if ((@as(c_int, @bitCast(@as(c_uint, flags))) & (1 << 2)) != 0) {
            _ = printf(gettext(" (don't care)"));
        }
        if ((@as(c_int, @bitCast(@as(c_uint, flags))) & (1 << 3)) != 0) {
            _ = printf(gettext(" (no ~ expansion)"));
        }
        _ = puts("...");
    }
    if (!((@as(c_int, @bitCast(@as(c_uint, flags))) & (1 << 3)) != 0) and (@as(c_int, @bitCast(@as(c_uint, filename[0]))) == @as(c_int, '~'))) {
    ...
    while (true) {
        ...
        if (!((ebuf.fp == null) and (__errno_location().* == 4))) break;
    }
    deps.*.c_error_fn_replaced_for_reserved_keyword = __errno_location().*;
    while (true) {
        switch (deps.*.c_error_fn_replaced_for_reserved_keyword) {
            24, 23, 12 => {
                {
                    var err: [*c]const u8 = strerror(deps.*.c_error_fn_replaced_for_reserved_keyword);
    ...
    if ((((((ebuf.fp == @as([*c]FILE, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(0)))))) and (deps.*.c_error_fn_replaced_for_reserved_keyword == 2)) and (include_directories != null)) and ((@as(c_int, @bitCast(@as(c_uint, flags))) & (1 << 1)) != 0)) and !false) and !((@as(c_int, @bitCast(@as(c_uint, stopchar_map[@as(u8, @bitCast(filename.*))]))) & 32768) != 0)) {
        var dir: [*c][*c]const u8 = undefined;
        {
            dir = include_directories;
            while (dir.* != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(0)))))) : (dir += 1) {
                var included: [*c]const u8 = concat(uint, dir.*, "/", filename);
                while (true) {
                    __errno_location().* = 0;
    ...
    free(@as(?*anyopaque, @ptrCast(expanded)));
    if (ebuf.fp == null) {
        __errno_location().* = deps.*.c_error_fn_replaced_for_reserved_keyword;
        deps.*.file.*.last_mtime = 1;
        return deps;
    }
    deps.*.c_error_fn_replaced_for_reserved_keyword = 0;
    if (deps.*.file.*.last_mtime == @as(uintmax_t, 1)) {
        deps.*.file.*.last_mtime = 0;
    }
    fd_noinherit(fileno(ebuf.fp));
    _ = do_variable_definition(&ebuf.floc, "MAKEFILE_LIST", filename, @as(c_uint, @bitCast(o_file)), @as(c_uint, @bitCast(f_append_value)), 0);
    ebuf.size = 200;
    ebuf.buffer = blk: {
        const tmp = blk_1: {
    ...
    curfile = reading_file;
    reading_file = &ebuf.floc;
    eval(&ebuf, @intFromBool(!((@as(c_int, @bitCast(@as(c_uint, flags))) & (1 << 0)) != 0)));
    reading_file = curfile;
    _ = fclose(ebuf.fp);
...
pub fn do_undefine(arg_name: [*c]u8, arg_origin: enum_variable_origin, arg_ebuf: [*c]struct_ebuffer) callconv(.C) void {
    ...
    _ = &@"var";
    @"var" = allocated_variable_expand_for_file(name, @as(?*struct_file, @ptrFromInt(0)));
    name = next_token(@"var");
    if (@as(c_int, @bitCast(@as(c_uint, name.*))) == @as(c_int, '\x00')) {
        fatal(&ebuf.*.floc, @as(usize, 0), gettext("empty variable name"));
    }
    p = (name + strlen(name)) - @as(usize, @bitCast(@as(isize, 1)));
    while ((p > name) and ((@as(c_int, @bitCast(@as(c_uint, stopchar_map[@as(u8, @bitCast(p.*))]))) & 2) != 0)) {
        p -= 1;
    }
    p[1] = '\x00';
    undefine_variable_in_set(name, @as(usize, @bitCast(@divExact(@as(c_long, @bitCast(@intFromPtr(p) -% @intFromPtr(name))), @sizeOf(u8)) + long)), origin, null);
...
pub fn check_specials(arg_files: [*c]struct_nameseq, arg_set_default: c_int) callconv(.C) void {
    ...
    {
        t = files;
        while (t != @as([*c]struct_nameseq, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(0)))))) : (t = t.*.next) {
            var nm: [*c]const u8 = t.*.name;
            if (!(posix_pedantic != 0) and ((nm == @as([*c]const u8, @ptrCast(@alignCast(".POSIX")))) or ((@as(c_int, @bitCast(@as(c_uint, nm.*))) == @as(c_int, @bitCast(@as(c_uint, ".POSIX".*)))) and ((@as(c_int, @bitCast(@as(c_uint, nm.*))) == @as(c_int, '\x00')) or !(strcmp(nm + @as(usize, @bitCast(@as(isize, 1))), ".POSIX" + @as(usize, @bitCast(@as(isize, 1)))) != 0))))) {
                posix_pedantic = 1;
                _ = define_variable_in_set(".SHELLFLAGS", @sizeOf([12]u8) -% ulong, "-ec", @as(c_uint, @bitCast(o_default)), 0, current_variable_set_list.*.set, @as([*c]floc, @ptrFromInt(0)));
                _ = define_variable_in_set("CC", @sizeOf([3]u8) -% ulong, "c99", @as(c_uint, @bitCast(o_default)), 0, current_variable_set_list.*.set, @as([*c]floc, @ptrFromInt(0)));
                _ = define_variable_in_set("CFLAGS", @sizeOf([7]u8) -% ulong, "-O1", @as(c_uint, @bitCast(o_default)), 0, current_variable_set_list.*.set, @as([*c]floc, @ptrFromInt(0)));
                _ = define_variable_in_set("FC", @sizeOf([3]u8) -% ulong, "fort77", @as(c_uint, @bitCast(o_default)), 0, current_variable_set_list.*.set, @as([*c]floc, @ptrFromInt(0)));
                _ = define_variable_in_set("FFLAGS", @sizeOf([7]u8) -% ulong, "-O1", @as(c_uint, @bitCast(o_default)), 0, current_variable_set_list.*.set, @as([*c]floc, @ptrFromInt(0)));
                _ = define_variable_in_set("SCCSGETFLAGS", @sizeOf([13]u8) -% ulong, "-s", @as(c_uint, @bitCast(o_default)), 0, current_variable_set_list.*.set, @as([*c]floc, @ptrFromInt(0)));
                _ = define_variable_in_set("ARFLAGS", @sizeOf([8]u8) -% ulong, "-rv", @as(c_uint, @bitCast(o_default)), 0, current_variable_set_list.*.set, @as([*c]floc, @ptrFromInt(0)));
                continue;
            }
            if (!(second_expansion != 0) and ((nm == @as([*c]const u8, @ptrCast(@alignCast(".SECONDEXPANSION")))) or ((@as(c_int, @bitCast(@as(c_uint, nm.*))) == @as(c_int, @bitCast(@as(c_uint, ".SECONDEXPANSION".*)))) and ((@as(c_int, @bitCast(@as(c_uint, nm.*))) == @as(c_int, '\x00')) or !(strcmp(nm + @as(usize, @bitCast(@as(isize, 1))), ".SECONDEXPANSION" + @as(usize, @bitCast(@as(isize, 1)))) != 0))))) {
                second_expansion = 1;
                continue;
            }
            if (!(one_shell != 0) and ((nm == @as([*c]const u8, @ptrCast(@alignCast(".ONESHELL")))) or ((@as(c_int, @bitCast(@as(c_uint, nm.*))) == @as(c_int, @bitCast(@as(c_uint, ".ONESHELL".*)))) and ((@as(c_int, @bitCast(@as(c_uint, nm.*))) == @as(c_int, '\x00')) or !(strcmp(nm + @as(usize, @bitCast(@as(isize, 1))), ".ONESHELL" + @as(usize, @bitCast(@as(isize, 1)))) != 0))))) {
                one_shell = 1;
                continue;
            }
            if ((set_default != 0) and (@as(c_int, @bitCast(@as(c_uint, default_goal_var.*.value[0]))) == @as(c_int, '\x00'))) {
                ...
                if (!(reject != 0)) {
                    _ = define_variable_in_set(".DEFAULT_GOAL", @as(usize, 13), t.*.name, @as(c_uint, @bitCast(o_file)), 0, null, @as([*c]floc, @ptrFromInt(0)));
                }
            }
        }
    }
...
pub fn check_special_file(arg_file_1: ?*struct_file, arg_flocp: [*c]const floc) callconv(.C) void {
    ...
    var flocp = arg_flocp;
    if ((file_1.*.name == @as([*c]const u8, @ptrCast(@alignCast(".WAIT")))) or ((@as(c_int, @bitCast(@as(c_uint, file_1.*.name.*))) == @as(c_int, @bitCast(@as(c_uint, ".WAIT".*)))) and ((@as(c_int, @bitCast(@as(c_uint, file_1.*.name.*))) == @as(c_int, '\x00')) or !(strcmp(file_1.*.name + @as(usize, @bitCast(@as(isize, 1))), ".WAIT" + @as(usize, @bitCast(@as(isize, 1)))) != 0)))) {
        const wpre = struct {
            var static: c_uint = 0;
        };
        const wcmd = struct {
        ...
        if (!(wpre.static != 0) and (file_1.*.deps != null)) {
            c_error_fn_replaced_for_reserved_keyword(flocp, @as(usize, 0), gettext(".WAIT should not have prerequisites"));
            wpre.static = 1;
        }
        if (!(wcmd.static != 0) and (file_1.*.cmds != null)) {
            c_error_fn_replaced_for_reserved_keyword(flocp, @as(usize, 0), gettext(".WAIT should not have commands"));
            wcmd.static = 1;
        }
        return;
    }
...
pub fn record_files(arg_filenames: [*c]struct_nameseq, arg_are_also_makes: c_int, arg_pattern: [*c]const u8, arg_pattern_percent: [*c]const u8, arg_depstr: [*c]u8, arg_cmds_started: c_uint, arg_commands_1: [*c]u8, arg_commands_idx: usize, arg_two_colon: c_int, arg_prefix: u8, arg_flocp: [*c]const floc) callconv(.C) void {
    ...
    var name: [*c]const u8 = undefined;
    if (snapped_deps != 0) {
        fatal(flocp, @as(usize, 0), gettext("prerequisites cannot be defined in recipes"));
    }
    name = filenames.*.name;
    implicit_percent = find_percent_cached(&name);
    if (commands_idx > @as(usize, 0)) {
        ...
        fatal(flocp, @as(usize, 0), gettext("grouped targets must provide a recipe"));
    } else {
        cmds = null;
    }
    if (depstr == null) {
    ...
    if (implicit_percent != null) {
        ...
        if (pattern != null) {
            fatal(flocp, @as(usize, 0), gettext("mixed implicit and static pattern rules"));
        }
        ...
        while (filenames != null) {
            ...
            implicit_percent = find_percent_cached(&name);
            if (implicit_percent == null) {
                fatal(flocp, @as(usize, 0), gettext("mixed implicit and normal rules"));
            }
            targets[c] = name;
    ...
    while (true) {
        ...
        if ((pattern != null) and !(pattern_matches(pattern, pattern_percent, name) != 0)) {
            c_error_fn_replaced_for_reserved_keyword(flocp, strlen(name), gettext("target '%s' doesn't match the target pattern"), name);
        } else if (deps != null) {
        ...
        if (!(two_colon != 0)) {
            ...
            if ((cmds != null) and (cmds == f.*.cmds)) {
                c_error_fn_replaced_for_reserved_keyword(flocp, strlen(f.*.name), gettext("target '%s' given more than once in the same rule"), f.*.name);
            } else if (((cmds != null) and (f.*.cmds != null)) and (@as(c_int, @bitCast(f.*.is_target)) != 0)) {
                var l: usize = strlen(f.*.name);
                c_error_fn_replaced_for_reserved_keyword(&cmds.*.fileinfo, l, gettext("warning: overriding recipe for target '%s'"), f.*.name);
                c_error_fn_replaced_for_reserved_keyword(&f.*.cmds.*.fileinfo, l, gettext("warning: ignoring old recipe for target '%s'"), f.*.name);
            }
        ...
        if (pattern != null) {
            ...
            var o: [*c]u8 = patsubst_expand_pat(variable_buffer, name, pattern, percent.static, pattern_percent + @as(usize, @bitCast(@as(isize, 1))), percent.static + @as(usize, @bitCast(@as(isize, 1))));
        ...
        if (find_percent_cached(&name) != null) {
            c_error_fn_replaced_for_reserved_keyword(flocp, @as(usize, 0), gettext("*** mixed implicit and normal rules: deprecated syntax"));
        }
    }
    {
        ...
        {
            i = also_make;
            while (i != @as(?*struct_dep, @ptrCast(@as(?*anyopaque, @ptrFromInt(0))))) : (i = i.*.next) {
                var f: ?*struct_file = i.*.file;
                var cpy: ?*struct_dep = if (i.*.next != null) copy_dep_chain(also_make) else also_make;
                if (f.*.also_make != null) {
                    c_error_fn_replaced_for_reserved_keyword(&cmds.*.fileinfo, strlen(f.*.name), gettext("warning: overriding group membership for target '%s'"), f.*.name);
    ...
    while (filenames != null) : (filenames = nextf) {
        ...
        if (percent != null) {
            ...
            if (@as(c_int, @bitCast(v.*.flavor)) == f_simple) {
                v.*.value = allocated_variable_expand_for_file(v.*.value, @as(?*struct_file, @ptrFromInt(0)));
            } else {
            ...
            if (!(v != null)) {
                fatal(flocp, @as(usize, 0), gettext("Malformed target-specific variable definition"));
            }
...
pub fn remove_comments(arg_line: [*c]u8) callconv(.C) void {
    ...
    comment = find_map_unquote(line, 8 | 16384);
    if (comment != null) {
        comment.* = '\x00';
    }
}
pub fn find_map_unquote(arg_string: [*c]u8, arg_stopmap: c_int) callconv(.C) [*c]u8 {
    ...
    stopmap |= 1;
    while (true) {
        while (!((@as(c_int, @bitCast(@as(c_uint, stopchar_map[@as(u8, @bitCast(p.*))]))) & stopmap) != 0)) {
            p += 1;
        }
        ...
        if ((p > string) and (@as(c_int, @bitCast(@as(c_uint, (blk: {
            ...
            i += 1;
            if (string_len == @as(usize, 0)) {
                string_len = strlen(string);
            }
            {
                var hi: c_int = -@divTrunc(i, 2);
                _ = memmove(@as(?*anyopaque, @ptrCast(&(blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk p + @as(usize, @intCast(tmp)) else break :blk p - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*)), @as(?*const anyopaque, @ptrCast(&(blk: {
                    const tmp = @divTrunc(i, 2);
                    if (tmp >= 0) break :blk p + @as(usize, @intCast(tmp)) else break :blk p - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*)), ((string_len -% @as(usize, @bitCast(@divExact(@as(c_long, @bitCast(@intFromPtr(p) -% @intFromPtr(string))), @sizeOf(u8))))) +% @as(usize, @bitCast(@as(c_long, hi)))) +% @as(usize, 1));
                p += @as(usize, @bitCast(@as(isize, @intCast(@divTrunc(i, 2)))));
            }
            if (@import("std").zig.c_translation.signedRemainder(i, 2) == 0) return p;
        } else return p;
    }
    return null;
}
...
pub fn readstring(arg_ebuf: [*c]struct_ebuffer) callconv(.C) c_long {
    ...
    if (ebuf.*.bufnext >= (ebuf.*.bufstart + ebuf.*.size)) return @as(c_long, @bitCast(@as(c_long, -1)));
    eol = blk: {
    ...
    while (true) {
        ...
        if (!(eol != null)) {
            ebuf.*.bufnext = (ebuf.*.bufstart + ebuf.*.size) + @as(usize, @bitCast(@as(isize, 1)));
            return 0;
        }
    ...
    eol.* = '\x00';
    ebuf.*.bufnext = eol + @as(usize, @bitCast(@as(isize, 1)));
    return 0;
}
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/assert.h:40:10
pub inline fn assert(expr: anytype) @TypeOf(__ASSERT_VOID_CAST(0)) {
    return __ASSERT_VOID_CAST(0);
}
pub inline fn assert_perror(errnum: anytype) @TypeOf(__ASSERT_VOID_CAST(0)) {
    return __ASSERT_VOID_CAST(0);
}
pub const static_assert = @compileError("unable to translate C expr: unexpected token '_Static_assert'");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/assert.h:155:10
pub const _hash_h_ = "";
...
pub const COMMANDS_RECURSE = 1;
pub const COMMANDS_SILENT = 2;
pub const COMMANDS_NOERROR = 4;
pub const EXP_COUNT_BITS = 15;
pub const EXP_COUNT_MAX = (1 << EXP_COUNT_BITS) - 1;
...
pub inline fn define_variable_cname(n: anytype, v: anytype, o: anytype, r: anytype) @TypeOf(define_variable_in_set(n, @import("std").zig.c_translation.sizeof(n) - 1, v, o, r, current_variable_set_list.*.set, NILF)) {
    return define_variable_in_set(n, @import("std").zig.c_translation.sizeof(n) - 1, v, o, r, current_variable_set_list.*.set, NILF);
}
