...
pub export fn patsubst_expand_pat(arg_o: [*c]u8, arg_text: [*c]const u8, arg_pattern: [*c]const u8, arg_replace: [*c]const u8, arg_pattern_percent: [*c]const u8, arg_replace_percent: [*c]const u8) [*c]u8 {
    ...
    if (replace_percent != null) {
        replace_prepercent_len = @as(usize, @bitCast(@divExact(@as(c_long, @bitCast(@intFromPtr(replace_percent) -% @intFromPtr(replace))), @sizeOf(u8)) - long));
    ...
    pattern_prepercent_len = @as(usize, @bitCast(@divExact(@as(c_long, @bitCast(@intFromPtr(pattern_percent) -% @intFromPtr(pattern))), @sizeOf(u8)) - long));
    ...
    while ((blk: {
        ...
        }).*))))) or !(strncmp(t + @as(usize, @bitCast(@as(isize, 1))), pattern + @as(usize, @bitCast(@as(isize, 1))), pattern_prepercent_len -% @as(usize, 1)) == 0))) {
            fail = 1;
        }
...
pub export fn shell_completed(arg_exit_code: c_int, arg_exit_sig: c_int) void {
    ...
    if ((exit_sig == 0) and (exit_code == 127)) {
    ...
    _ = define_variable_in_set(".SHELLSTATUS", @sizeOf([13]u8) -% ulong, @as([*c]u8, @ptrCast(@alignCast(&buf))), @as(c_uint, @bitCast(o_override)), 0, current_variable_set_list.*.set, @as([*c]floc, @ptrFromInt(0)));
}
...
pub export fn hash_init_function_table() void {
    hash_init(&function_table, (@sizeOf([38]struct_function_table_entry) / @sizeOf(struct_function_table_entry)) *% ulong, &function_table_entry_hash_1, &function_table_entry_hash_2, &function_table_entry_hash_cmp);
...
pub export fn define_new_function(arg_flocp: [*c]const floc, arg_name: [*c]const u8, arg_min: c_uint, arg_max: c_uint, arg_flags: c_uint, arg_func: gmk_func_ptr) void {
    ...
    var ent: ?*struct_function_table_entry = undefined;
    var len: usize = undefined;
    while ((@as(c_int, @bitCast(@as(c_uint, stopchar_map[@as(u8, @bitCast(e.*))]))) & 8192) != 0) {
        e += 1;
    }
    ...
    if (min > uint) {
        fatal(flocp, (((ulong *% @sizeOf(uintmax_t)) / ulong) +% ulong) +% strlen(name), gettext("Invalid minimum argument count (%u) for function %s"), min, name);
    }
    if ((max > uint) or ((max != 0) and (max < min))) {
        fatal(flocp, (((ulong *% @sizeOf(uintmax_t)) / ulong) +% ulong) +% strlen(name), gettext("Invalid maximum argument count (%u) for function %s"), max, name);
    }
    ent = @as(?*struct_function_table_entry, @ptrCast(xmalloc(@sizeOf(struct_function_table_entry))));
    ...
    ent.*.expand_args = @as(c_uint, @bitCast(if ((flags & uint) != uint) 0 else 1));
    ent.*.alloc_fn = 1;
    ent.*.adds_command = 1;
    ent.*.fptr.alloc_func_ptr = func;
    ent = @as(?*struct_function_table_entry, @ptrCast(hash_insert(&function_table, @as(?*const anyopaque, @ptrCast(ent)))));
...
pub fn find_next_argument(arg_startparen: u8, arg_endparen: u8, arg_ptr: [*c]const u8, arg_end: [*c]const u8) callconv(.C) [*c]u8 {
    ...
    var end = arg_end;
    var count: c_int = 0;
    while (ptr < end) : (ptr += 1) if (!((@as(c_int, @bitCast(@as(c_uint, stopchar_map[@as(u8, @bitCast(ptr.*))]))) & (128 | 1024)) != 0)) continue else if (@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, @bitCast(@as(c_uint, startparen)))) {
        count += 1;
...
pub fn string_glob(arg_line: [*c]u8) callconv(.C) [*c]u8 {
    ...
    chain = @as([*c]struct_nameseq, @ptrCast(@alignCast(parse_file_seq(&line, @sizeOf(struct_nameseq), 1, null, (1 | 16) | 8))));
    if (result.static == null) {
        length.static = 100;
        result.static = @as([*c]u8, @ptrCast(@alignCast(xmalloc(@as(usize, 100)))));
    }
    idx = 0;
    while (chain != null) {
...
pub fn func_origin(arg_o: [*c]u8, arg_argv: [*c][*c]u8, arg_funcname: [*c]const u8) callconv(.C) [*c]u8 {
    ...
    var argv = arg_argv;
    var funcname = arg_funcname;
    var v: ?*struct_variable = lookup_variable(argv[0], strlen(argv[0]));
    if (v == null) {
        ...
        while (true) {
            switch (@as(c_int, @bitCast(v.*.origin))) {
                ...
                1 => {
                    o = variable_buffer_output(o, "environment", @as(usize, 11));
                    break;
                },
                2 => {
                ...
                3 => {
                    o = variable_buffer_output(o, "environment override", @as(usize, 20));
                    break;
                },
                4 => {
                    o = variable_buffer_output(o, "command line", @as(usize, 12));
                    break;
                },
                5 => {
...
pub fn func_notdir_suffix(arg_o: [*c]u8, arg_argv: [*c][*c]u8, arg_funcname: [*c]const u8) callconv(.C) [*c]u8 {
    ...
    var stop: c_int = 32768 | (if (is_suffix != 0) 512 else 0);
    while ((blk: {
        const tmp = find_next_token(&list_iterator, &len);
        p2 = tmp;
        break :blk tmp;
    }) != null) {
        var p: [*c]const u8 = (p2 + len) - @as(usize, @bitCast(@as(isize, 1)));
...
pub fn func_basename_dir(arg_o: [*c]u8, arg_argv: [*c][*c]u8, arg_funcname: [*c]const u8) callconv(.C) [*c]u8 {
    ...
    var stop: c_int = (32768 | (if (is_basename != 0) 512 else 0)) | 1;
    while ((blk: {
...
pub fn parse_numeric(arg_s: [*c]const u8, arg_msg: [*c]const u8) callconv(.C) c_longlong {
    ...
    var end: [*c]const u8 = (s + strlen(s)) - @as(usize, @bitCast(@as(isize, 1)));
...
pub fn func_foreach(arg_o: [*c]u8, arg_argv: [*c][*c]u8, arg_funcname: [*c]const u8) callconv(.C) [*c]u8 {
    ...
    while ((blk: {
        ...
        result = allocated_variable_expand_for_file(body, @as(?*struct_file, @ptrFromInt(0)));
...
pub fn func_let(arg_o: [*c]u8, arg_argv: [*c][*c]u8, arg_funcname: [*c]const u8) callconv(.C) [*c]u8 {
    ...
    o = variable_expand_string(o, body, 18446744073709551615);
    pop_variable_scope();
...
pub fn func_filter_filterout(arg_o: [*c]u8, arg_argv: [*c][*c]u8, arg_funcname: [*c]const u8) callconv(.C) [*c]u8 {
    ...
    var is_filter: c_int = @intFromBool(@as(c_int, @bitCast(@as(c_uint, funcname[@sizeOf([7]u8) -% ulong]))) == @as(c_int, '\x00'));
    ...
    hashing = @intFromBool((literals > 1) and ((@as(c_ulong, @bitCast(@as(c_long, literals))) *% word_count) >= ulong));
    if (hashing != 0) {
...
pub fn parse_textint(arg_number: [*c]const u8, arg_msg: [*c]const u8, arg_sign: [*c]c_int, arg_numstart: [*c][*c]const u8) callconv(.C) [*c]const u8 {
    ...
    numstart.* = p;
    while ((@as(c_uint, @bitCast(@as(c_uint, p.*))) -% @as(c_uint, @bitCast(@as(c_int, '0')))) <= uint) {
        p += 1;
    }
    after_number = p;
...
pub fn func_intcmp(arg_o: [*c]u8, arg_argv: [*c][*c]u8, arg_funcname: [*c]const u8) callconv(.C) [*c]u8 {
    ...
    argv += @as(usize, @bitCast(@as(isize, 2)));
    ...
    if ((argv.* != null) and (cmp >= 0)) {
        argv += 1;
        if (((cmp > 0) and (argv.* != null)) and ((argv + @as(usize, @bitCast(@as(isize, 1)))).* != null)) {
            argv += 1;
        }
    }
    if (argv.* != null) {
...
pub fn func_if(arg_o: [*c]u8, arg_argv: [*c][*c]u8, arg_funcname: [*c]const u8) callconv(.C) [*c]u8 {
    ...
    var endp: [*c]const u8 = (begp + strlen(argv[0])) - @as(usize, @bitCast(@as(isize, 1)));
    var result: c_int = 0;
    _ = strip_whitespace(&begp, &endp);
    if (begp <= endp) {
        var expansion: [*c]u8 = expand_argument(begp, endp + @as(usize, @bitCast(@as(isize, 1))));
...
pub fn func_or(arg_o: [*c]u8, arg_argv: [*c][*c]u8, arg_funcname: [*c]const u8) callconv(.C) [*c]u8 {
    ...
    while (argv.* != null) : (argv += 1) {
        ...
        var endp: [*c]const u8 = (begp + strlen(argv.*)) - @as(usize, @bitCast(@as(isize, 1)));
        var expansion: [*c]u8 = undefined;
        var result: usize = 0;
        _ = strip_whitespace(&begp, &endp);
        if (begp > endp) continue;
        expansion = expand_argument(begp, endp + @as(usize, @bitCast(@as(isize, 1))));
...
pub fn fold_newlines(arg_buffer: [*c]u8, arg_length: [*c]usize, arg_trim_newlines: c_int) callconv(.C) void {
    ...
    var dst: [*c]u8 = buffer;
    var src: [*c]u8 = buffer;
    var last_nonnl: [*c]u8 = buffer - @as(usize, @bitCast(@as(isize, 1)));
    src[length.*] = 0;
    ...
    if (!(trim_newlines != 0) and (last_nonnl < (dst - @as(usize, @bitCast(@as(isize, 2)))))) {
        last_nonnl = dst - @as(usize, @bitCast(@as(isize, 2)));
    }
    (blk: {
...
pub fn abspath(arg_name: [*c]const u8, arg_apath: [*c]u8) callconv(.C) [*c]u8 {
    ...
    apath_limit = apath + @as(usize, @bitCast(@as(isize, 4096)));
    ...
    }
    {
        ...
        while (@as(c_int, @bitCast(@as(c_uint, start.*))) != @as(c_int, '\x00')) : (start = end) {
            var len: usize = undefined;
            while ((@as(c_int, @bitCast(@as(c_uint, stopchar_map[@as(u8, @bitCast(start.*))]))) & 32768) != 0) {
                start += 1;
            }
            {
                end = start;
                while (!((@as(c_int, @bitCast(@as(c_uint, stopchar_map[@as(u8, @bitCast(end.*))]))) & (32768 | 1)) != 0)) : (end += 1) {}
            }
...
// src/debug.h:41:9
pub inline fn IS_ABSOLUTE(n: anytype) @TypeOf(n[@as(usize, 0)] == '/') {
    return n[@as(usize, 0)] == '/';
}
pub const ROOT_LEN = 1;
