...
pub export fn construct_command_argv(arg_line: [*c]u8, arg_restp: [*c][*c]u8, arg_file_1: ?*struct_file, arg_cmd_flags: c_int, arg_batch_filename: [*c][*c]u8) [*c][*c]u8 {
    ...
    var argv: [*c][*c]u8 = undefined;
    {
        ...
        @"var" = lookup_variable_for_file(".SHELLFLAGS", @sizeOf([12]u8) -% ulong, file_1);
        if (!(@"var" != null)) {
            shellflags = xstrdup("");
...
pub const struct___spawn_action_38 = opaque {};
...
pub extern fn posix_spawn(noalias __pid: [*c]pid_t, noalias __path: [*c]const u8, noalias __file_actions: [*c]const posix_spawn_file_actions_t, noalias __attrp: [*c]const posix_spawnattr_t, noalias __argv: [*c]const [*c]u8, noalias __envp: [*c]const [*c]u8) c_int;
pub extern fn posix_spawnp(__pid: [*c]pid_t, __file: [*c]const u8, __file_actions: [*c]const posix_spawn_file_actions_t, __attrp: [*c]const posix_spawnattr_t, __argv: [*c]const [*c]u8, __envp: [*c]const [*c]u8) c_int;
pub extern fn posix_spawnattr_init(__attr: [*c]posix_spawnattr_t) c_int;
pub extern fn posix_spawnattr_destroy(__attr: [*c]posix_spawnattr_t) c_int;
...
pub extern fn posix_spawn_file_actions_init(__file_actions: [*c]posix_spawn_file_actions_t) c_int;
pub extern fn posix_spawn_file_actions_destroy(__file_actions: [*c]posix_spawn_file_actions_t) c_int;
pub extern fn posix_spawn_file_actions_addopen(noalias __file_actions: [*c]posix_spawn_file_actions_t, __fd: c_int, noalias __path: [*c]const u8, __oflag: c_int, __mode: mode_t) c_int;
pub extern fn posix_spawn_file_actions_addclose(__file_actions: [*c]posix_spawn_file_actions_t, __fd: c_int) c_int;
pub extern fn posix_spawn_file_actions_adddup2(__file_actions: [*c]posix_spawn_file_actions_t, __fd: c_int, __newfd: c_int) c_int;
pub extern fn posix_spawn_file_actions_addchdir_np(noalias __actions: [*c]posix_spawn_file_actions_t, noalias __path: [*c]const u8) c_int;
pub extern fn posix_spawn_file_actions_addfchdir_np([*c]posix_spawn_file_actions_t, __fd: c_int) c_int;
pub extern fn posix_spawn_file_actions_addclosefrom_np([*c]posix_spawn_file_actions_t, __from: c_int) c_int;
pub extern fn posix_spawn_file_actions_addtcsetpgrp_np([*c]posix_spawn_file_actions_t, __tcfd: c_int) c_int;
pub extern fn posix_spawnattr_getcgroup_np(noalias __attr: [*c]const posix_spawnattr_t, noalias __cgroup: [*c]c_int) c_int;
pub extern fn posix_spawnattr_setcgroup_np(__attr: [*c]posix_spawnattr_t, __cgroup: c_int) c_int;
pub extern fn pidfd_spawn(noalias __pidfd: [*c]c_int, noalias __path: [*c]const u8, noalias __facts: [*c]const posix_spawn_file_actions_t, noalias __attrp: [*c]const posix_spawnattr_t, noalias __argv: [*c]const [*c]u8, noalias __envp: [*c]const [*c]u8) c_int;
pub extern fn pidfd_spawnp(noalias __pidfd: [*c]c_int, noalias __file: [*c]const u8, noalias __facts: [*c]const posix_spawn_file_actions_t, noalias __attrp: [*c]const posix_spawnattr_t, noalias __argv: [*c]const [*c]u8, noalias __envp: [*c]const [*c]u8) c_int;
pub extern fn find_in_path(progname: [*c]const u8) [*c]const u8;
pub extern fn find_in_given_path(progname: [*c]const u8, path: [*c]const u8, directory: [*c]const u8, optimize_for_exec: bool) [*c]const u8;
...
pub fn free_child(arg_child_1: ?*struct_child) callconv(.C) void {
    ...
    if (!(jobserver_tokens != 0)) {
        fatal(@as([*c]floc, @ptrFromInt(0)), (((ulong *% @sizeOf(uintmax_t)) / ulong) +% ulong) +% strlen(child_1.*.file.*.name), "INTERNAL: Freeing child %p (%s) but no tokens left", child_1, child_1.*.file.*.name);
    }
    if ((jobserver_enabled() != 0) and (jobserver_tokens > uint)) {
        jobserver_release(1);
        while (true) {
            if ((4 & db_level) != 0) {
...
pub fn load_too_high() callconv(.C) c_int {
    ...
    if (proc_fd.static >= 0) {
        ...
        if (r >= 0) {
            ...
            while (((blk: {
                const tmp = @as(c_int, @bitCast(@as(c_int, @truncate(read(proc_fd.static, @as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(&avg))))), @as(usize, 64))))));
                r = tmp;
                break :blk tmp;
            }) == -1) and (__errno_location().* == 4)) {}
            if (r >= 0) {
                ...
                if (p != null) {
                    p = strchr(p + @as(usize, @bitCast(@as(isize, 1))), @as(c_int, ' '));
                }
                if (p != null) {
                    p = strchr(p + @as(usize, @bitCast(@as(isize, 1))), @as(c_int, ' '));
                }
                if ((p != null) and ((@as(c_uint, @bitCast(@as(c_uint, p[1]))) -% @as(c_uint, @bitCast(@as(c_int, '0')))) <= uint)) {
                    var cnt: c_uint = make_toui(p + @as(usize, @bitCast(@as(isize, 1))), null);
                    while (true) {
                        if ((4 & db_level) != 0) {
    ...
    if (getloadavg(&load, 1) != 1) {
        ...
        if ((lossage.static == -1) or (__errno_location().* != lossage.static)) {
            if (__errno_location().* == 0) {
                c_error_fn_replaced_for_reserved_keyword(@as([*c]floc, @ptrFromInt(0)), @as(usize, 0), gettext("cannot enforce load limits on this operating system"));
            } else {
...
pub fn job_next_command(arg_child_1: ?*struct_child) callconv(.C) c_int {
    ...
    child_1.*.file.*.cmds.*.fileinfo.offset = @as(c_ulong, @bitCast(@as(c_ulong, child_1.*.command_line -% uint)));
    return 1;
}
pub fn start_waiting_job(arg_c: ?*struct_child) callconv(.C) c_int {
    ...
    if (!(c.*.remote != 0) and ((job_slots_used > uint) and (load_too_high() != 0))) {
...
pub inline fn WAIT_NOHANG(status: anytype) @TypeOf(waitpid(-1, status, WNOHANG)) {
    return waitpid(-1, status, WNOHANG);
}
pub const _SPAWN_H = 1;
...
pub const __NCPUBITS = 8 * @import("std").zig.c_translation.sizeof(__cpu_mask);
...
pub inline fn __CPUMASK(cpu: anytype) @TypeOf(@import("std").zig.c_translation.cast(__cpu_mask, 1) << @import("std").zig.c_translation.MacroArithmetic.rem(cpu, __NCPUBITS)) {
    return @import("std").zig.c_translation.cast(__cpu_mask, 1) << @import("std").zig.c_translation.MacroArithmetic.rem(cpu, __NCPUBITS);
}
pub const __CPU_ZERO_S = @compileError("unable to translate C expr: unexpected token 'do'");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/cpu-set.h:46:10
pub const __CPU_SET_S = @compileError("unable to translate macro: undefined identifier `__cpu`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/cpu-set.h:58:9
pub const __CPU_CLR_S = @compileError("unable to translate macro: undefined identifier `__cpu`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/cpu-set.h:65:9
pub const __CPU_ISSET_S = @compileError("unable to translate macro: undefined identifier `__cpu`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/cpu-set.h:72:9
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/cpu-set.h:84:10
pub const __CPU_OP_S = @compileError("unable to translate macro: undefined identifier `__dest`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/cpu-set.h:99:9
pub inline fn __CPU_ALLOC_SIZE(count: anytype) @TypeOf(@import("std").zig.c_translation.MacroArithmetic.div((count + __NCPUBITS) - 1, __NCPUBITS) * @import("std").zig.c_translation.sizeof(__cpu_mask)) {
    return @import("std").zig.c_translation.MacroArithmetic.div((count + __NCPUBITS) - 1, __NCPUBITS) * @import("std").zig.c_translation.sizeof(__cpu_mask);
}
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/sched.h:48:9
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/sched.h:111:10
pub const CPU_OR = @compileError("unable to translate C expr: unexpected token '|'");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/sched.h:113:10
pub const CPU_XOR = @compileError("unable to translate C expr: unexpected token '^'");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/sched.h:115:10
pub const CPU_AND_S = @compileError("unable to translate C expr: unexpected token ')'");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/sched.h:117:10
pub const CPU_OR_S = @compileError("unable to translate C expr: unexpected token '|'");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/sched.h:119:10
pub const CPU_XOR_S = @compileError("unable to translate C expr: unexpected token '^'");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/sched.h:121:10
...
pub const POSIX_SPAWN_USEVFORK = @as(c_int, 0x40);
pub const POSIX_SPAWN_SETSID = @as(c_int, 0x80);
pub const POSIX_SPAWN_SETCGROUP = @as(c_int, 0x100);
pub const _FINDPROG_H = "";
pub const WAIT_T = c_int;
pub const SHUFFLE_PREFIX = " shuffle=";
pub const REAP_MORE = @compileError("unable to translate macro: undefined identifier `reap_more`");
// src/job.c:642:10
pub const FREE_ARGV = @compileError("unable to translate C expr: unexpected token 'do'");
// src/job.c:1182:10
pub const LOAD_WEIGHT_A = @as(f64, 0.25);
pub const LOAD_WEIGHT_B = @as(f64, 0.25);
pub const LOADAVG = "/proc/loadavg";
pub const PROC_LOADAVG_SIZE = 64;
pub const PRESERVE_BSNL = 1;
