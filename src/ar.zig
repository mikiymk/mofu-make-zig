...
pub fn __bswap_16(arg___bsx: __uint16_t) callconv(.C) __uint16_t {
    var __bsx = arg___bsx;
    return @as(__uint16_t, @bitCast(@as(c_short, @truncate(((@as(c_int, @bitCast(@as(c_uint, __bsx))) >> 8) & 255) | ((@as(c_int, @bitCast(@as(c_uint, __bsx))) & 255) << 8)))));
}
...
pub fn __bswap_64(arg___bsx: __uint64_t) callconv(.C) __uint64_t {
    var __bsx = arg___bsx;
    return @as(__uint64_t, @bitCast(@as(c_ulong, @truncate(((((((((@as(c_ulonglong, @bitCast(@as(c_ulonglong, __bsx))) & @as(c_ulonglong, 18374686479671623680)) >> 56) | ((@as(c_ulonglong, @bitCast(@as(c_ulonglong, __bsx))) & @as(c_ulonglong, 71776119061217280)) >> 40)) | ((@as(c_ulonglong, @bitCast(@as(c_ulonglong, __bsx))) & @as(c_ulonglong, 280375465082880)) >> 24)) | ((@as(c_ulonglong, @bitCast(@as(c_ulonglong, __bsx))) & @as(c_ulonglong, 1095216660480)) >> 8)) | ((@as(c_ulonglong, @bitCast(@as(c_ulonglong, __bsx))) & @as(c_ulonglong, 4278190080)) << 8)) | ((@as(c_ulonglong, @bitCast(@as(c_ulonglong, __bsx))) & @as(c_ulonglong, 16711680)) << 24)) | ((@as(c_ulonglong, @bitCast(@as(c_ulonglong, __bsx))) & @as(c_ulonglong, 65280)) << 40)) | ((@as(c_ulonglong, @bitCast(@as(c_ulonglong, __bsx))) & @as(c_ulonglong, 255)) << 56)))));
}
...
pub const struct_variable_set_list = opaque {};
...
pub extern fn c_error_fn_replaced_for_reserved_keyword(flocp: [*c]const floc, length: usize, fmt: [*c]const u8, ...) void;
...
pub export fn ar_name(arg_name: [*c]const u8) c_int {
    ...
    if ((p == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(0)))))) or (p == name)) return 0;
    end = (p + strlen(p)) - @as(usize, @bitCast(@as(isize, 1)));
    if ((@as(c_int, @bitCast(@as(c_uint, end.*))) != @as(c_int, ')')) or (end == (p + @as(usize, @bitCast(@as(isize, 1)))))) return 0;
    if ((@as(c_int, @bitCast(@as(c_uint, p[1]))) == @as(c_int, '(')) and (@as(c_int, @bitCast(@as(c_uint, (blk: {
        ...
        fatal(@as([*c]floc, @ptrFromInt(0)), strlen(name), gettext("attempt to use unsupported feature: '%s'"), name);
    }
    return 1;
}
pub export fn ar_parse_name(arg_name: [*c]const u8, arg_arname_p: [*c][*c]u8, arg_memname_p: [*c][*c]u8) void {
    ...
    if (!(p != null)) {
        fatal(@as([*c]floc, @ptrFromInt(0)), strlen(arname_p.*), "Internal: ar_parse_name: bad name '%s'", arname_p.*);
    }
    (blk: {
        const ref = &p;
        const tmp = ref.*;
...
pub export fn ar_touch(arg_name: [*c]const u8) c_int {
    ...
    while (true) {
        switch (ar_member_touch(arname, memname)) {
            @as(c_int, -1) => {
                c_error_fn_replaced_for_reserved_keyword(@as([*c]floc, @ptrFromInt(0)), strlen(arname), gettext("touch: Archive '%s' does not exist"), arname);
                break;
            },
            @as(c_int, -2) => {
                c_error_fn_replaced_for_reserved_keyword(@as([*c]floc, @ptrFromInt(0)), strlen(arname), gettext("touch: '%s' is not a valid archive"), arname);
                break;
            },
            @as(c_int, -3) => {
            ...
            1 => {
                c_error_fn_replaced_for_reserved_keyword(@as([*c]floc, @ptrFromInt(0)), strlen(memname) +% strlen(arname), gettext("touch: Member '%s' does not exist in '%s'"), memname, arname);
                break;
            },
            0 => {
                val = 0;
                ...
                c_error_fn_replaced_for_reserved_keyword(@as([*c]floc, @ptrFromInt(0)), strlen(name), gettext("touch: Bad return code from ar_member_touch on '%s'"), name);
            },
        }
        break;
    }
...
pub export fn ar_member_date(arg_name: [*c]const u8) time_t {
    ...
    free(@as(?*anyopaque, @ptrCast(arname)));
    return if ((@as(intmax_t, 0) < val) and (val <= (if (!!(@as(time_t, 0) < @as(time_t, @bitCast(@as(c_long, -1))))) @as(time_t, @bitCast(@as(c_long, -1))) else (((@as(time_t, 1) << @intCast((@sizeOf(time_t) *% ulong) -% ulong)) - @as(time_t, 1)) * @as(time_t, 2)) + @as(time_t, 1)))) val else @as(intmax_t, @bitCast(@as(c_long, -1)));
}
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/alloca.h:35:23: warning: TODO implement function '__builtin_alloca' in std.zig.c_builtins
...
pub fn ar_member_date_1(arg_desc: c_int, arg_mem: [*c]const u8, arg_truncated: c_int, arg_hdrpos: c_long, arg_datapos: c_long, arg_size: c_long, arg_date: intmax_t, arg_uid: c_int, arg_gid: c_int, arg_mode: c_uint, arg_name: ?*const anyopaque) callconv(.C) intmax_t {
    ...
    var mode = arg_mode;
    var name = arg_name;
    return if (ar_name_equal(@as([*c]const u8, @ptrCast(@alignCast(name))), mem, truncated) != 0) date else @as(intmax_t, 0);
}
pub fn ar_glob_match(arg_desc: c_int, arg_mem: [*c]const u8, arg_truncated: c_int, arg_hdrpos: c_long, arg_datapos: c_long, arg_size: c_long, arg_date: intmax_t, arg_uid: c_int, arg_gid: c_int, arg_mode: c_uint, arg_arg: ?*const anyopaque) callconv(.C) intmax_t {
    ...
    if (fnmatch(state.*.pattern, mem, (1 << 0) | (1 << 2)) == 0) {
        var new: [*c]struct_nameseq = @as([*c]struct_nameseq, @ptrCast(@alignCast(xcalloc(state.*.size))));
        new.*.name = strcache_add(concat(uint, state.*.arname, "(", mem, ")"));
...
// src/config.h:913:11
pub const _GL_ATTRIBUTE_DEALLOC_FREE = _GL_ATTRIBUTE_DEALLOC(free, 1);
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types.h:137:10
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/x86_64-linux-gnu/bits/typesizes.h:73:9
...
pub inline fn __bswap_constant_16(x: anytype) __uint16_t {
    return @import("std").zig.c_translation.cast(__uint16_t, ((x >> 8) & @as(c_int, 0xff)) | ((x & @as(c_int, 0xff)) << 8));
}
pub inline fn __bswap_constant_32(x: anytype) @TypeOf(((((x & @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0xff000000, .hex)) >> 24) | ((x & @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00ff0000, .hex)) >> 8)) | ((x & @as(c_uint, 0x0000ff00)) << 8)) | ((x & @as(c_uint, 0x000000ff)) << 24)) {
    return ((((x & @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0xff000000, .hex)) >> 24) | ((x & @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x00ff0000, .hex)) >> 8)) | ((x & @as(c_uint, 0x0000ff00)) << 8)) | ((x & @as(c_uint, 0x000000ff)) << 24);
}
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/select.h:25:9
pub const __FD_SET = @compileError("unable to translate C expr: expected ')' instead got '|='");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/select.h:32:9
pub const __FD_CLR = @compileError("unable to translate C expr: expected ')' instead got '&='");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/select.h:34:9
...
pub const _SIGSET_NWORDS = @import("std").zig.c_translation.MacroArithmetic.div(1024, 8 * @import("std").zig.c_translation.sizeof(c_ulong));
pub const __timeval_defined = 1;
pub const _STRUCT_TIMESPEC = 1;
pub const __NFDBITS = 8 * @import("std").zig.c_translation.cast(c_int, @import("std").zig.c_translation.sizeof(__fd_mask));
pub inline fn __FD_ELT(d: anytype) @TypeOf(@import("std").zig.c_translation.MacroArithmetic.div(d, __NFDBITS)) {
    return @import("std").zig.c_translation.MacroArithmetic.div(d, __NFDBITS);
}
pub inline fn __FD_MASK(d: anytype) __fd_mask {
    return @import("std").zig.c_translation.cast(__fd_mask, 1 << @import("std").zig.c_translation.MacroArithmetic.rem(d, __NFDBITS));
}
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/x86_64-linux-gnu/bits/struct_mutex.h:56:10
pub const _RWLOCK_INTERNAL_H = "";
pub const __PTHREAD_RWLOCK_ELISION_EXTRA = @compileError("unable to translate C expr: unexpected token '{'");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/x86_64-linux-gnu/bits/struct_rwlock.h:40:11
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/thread-shared-types.h:113:9
pub const __have_pthread_attr_t = 1;
pub const _SYS_STAT_H = 1;
pub const _BITS_STAT_H = 1;
pub const _BITS_STRUCT_STAT_H = 1;
pub const st_atime = @compileError("unable to translate macro: undefined identifier `st_atim`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/x86_64-linux-gnu/bits/struct_stat.h:77:11
pub const st_mtime = @compileError("unable to translate macro: undefined identifier `st_mtim`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/x86_64-linux-gnu/bits/struct_stat.h:78:11
pub const st_ctime = @compileError("unable to translate macro: undefined identifier `st_ctim`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/x86_64-linux-gnu/bits/struct_stat.h:79:11
...
pub const UTIME_NOW = (1 << 30) - 1;
pub const UTIME_OMIT = (1 << 30) - 2;
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/any-linux-any/linux/stddef.h:26:9
pub const __DECLARE_FLEX_ARRAY = @compileError("unable to translate macro: undefined identifier `__empty_`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/any-linux-any/linux/stddef.h:42:9
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/any-linux-any/linux/types.h:46:9
pub const __aligned_be64 = @compileError("unable to translate macro: undefined identifier `aligned`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/any-linux-any/linux/types.h:47:9
pub const __aligned_le64 = @compileError("unable to translate macro: undefined identifier `aligned`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/any-linux-any/linux/types.h:48:9
...
pub const __statx_timestamp_defined = 1;
pub const __statx_defined = 1;
pub const _SIGNAL_H = "";
pub const _BITS_SIGNUM_GENERIC_H = 1;
pub const SIG_ERR = @import("std").zig.c_translation.cast(__sighandler_t, -1);
pub const SIG_DFL = @import("std").zig.c_translation.cast(__sighandler_t, 0);
pub const SIG_IGN = @import("std").zig.c_translation.cast(__sighandler_t, 1);
pub const SIG_HOLD = @import("std").zig.c_translation.cast(__sighandler_t, 2);
pub const SIGINT = 2;
pub const SIGILL = 4;
pub const SIGABRT = 6;
pub const SIGFPE = 8;
...
pub const _BITS_SIGNUM_ARCH_H = 1;
...
pub const __SIGRTMAX = 64;
pub const _NSIG = __SIGRTMAX + 1;
...
pub const __SI_PAD_SIZE = @import("std").zig.c_translation.MacroArithmetic.div(__SI_MAX_SIZE, @import("std").zig.c_translation.sizeof(c_int)) - 4;
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:128:9
pub const si_uid = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:129:9
pub const si_timerid = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:130:9
pub const si_overrun = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:131:9
pub const si_status = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:132:9
pub const si_utime = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:133:9
pub const si_stime = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:134:9
pub const si_value = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:135:9
pub const si_int = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:136:9
pub const si_ptr = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:137:9
pub const si_addr = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:138:9
pub const si_addr_lsb = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:139:9
pub const si_lower = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:140:9
pub const si_upper = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:141:9
pub const si_pkey = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:142:9
pub const si_band = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:143:9
pub const si_fd = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:144:9
pub const si_call_addr = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:146:10
pub const si_syscall = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:147:10
pub const si_arch = @compileError("unable to translate macro: undefined identifier `_sifields`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/siginfo_t.h:148:10
pub const _BITS_SIGINFO_CONSTS_H = 1;
pub const __SI_ASYNCIO_AFTER_SIGIO = 1;
pub const _BITS_SIGINFO_CONSTS_ARCH_H = 1;
pub const __sigval_t_defined = "";
pub const __sigevent_t_defined = 1;
pub const __SIGEV_MAX_SIZE = 64;
pub const __SIGEV_PAD_SIZE = @import("std").zig.c_translation.MacroArithmetic.div(__SIGEV_MAX_SIZE, @import("std").zig.c_translation.sizeof(c_int)) - 4;
pub const sigev_notify_function = @compileError("unable to translate macro: undefined identifier `_sigev_un`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/sigevent_t.h:45:9
pub const sigev_notify_attributes = @compileError("unable to translate macro: undefined identifier `_sigev_un`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/sigevent_t.h:46:9
pub const _BITS_SIGEVENT_CONSTS_H = 1;
pub inline fn sigmask(sig: anytype) @TypeOf(__glibc_macro_warning("sigmask is deprecated")(@import("std").zig.c_translation.cast(c_int, 1 << (sig - 1)))) {
    return __glibc_macro_warning("sigmask is deprecated")(@import("std").zig.c_translation.cast(c_int, 1 << (sig - 1)));
}
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/sigaction.h:39:10
pub const sa_sigaction = @compileError("unable to translate macro: undefined identifier `__sigaction_handler`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/sigaction.h:40:10
...
pub const _POSIX_VERSION = 200809;
pub const __POSIX2_THIS_VERSION = 200809;
...
pub const _POSIX_PRIORITY_SCHEDULING = 200809;
pub const _POSIX_SYNCHRONIZED_IO = 200809;
pub const _POSIX_FSYNC = 200809;
pub const _POSIX_MAPPED_FILES = 200809;
pub const _POSIX_MEMLOCK = 200809;
pub const _POSIX_MEMLOCK_RANGE = 200809;
pub const _POSIX_MEMORY_PROTECTION = 200809;
...
pub const _POSIX_THREADS = 200809;
pub const _POSIX_REENTRANT_FUNCTIONS = 1;
pub const _POSIX_THREAD_SAFE_FUNCTIONS = 200809;
pub const _POSIX_THREAD_PRIORITY_SCHEDULING = 200809;
pub const _POSIX_THREAD_ATTR_STACKSIZE = 200809;
pub const _POSIX_THREAD_ATTR_STACKADDR = 200809;
pub const _POSIX_THREAD_PRIO_INHERIT = 200809;
pub const _POSIX_THREAD_PRIO_PROTECT = 200809;
pub const _POSIX_THREAD_ROBUST_PRIO_INHERIT = 200809;
pub const _POSIX_THREAD_ROBUST_PRIO_PROTECT = -1;
pub const _POSIX_SEMAPHORES = 200809;
pub const _POSIX_REALTIME_SIGNALS = 200809;
pub const _POSIX_ASYNCHRONOUS_IO = 200809;
pub const _POSIX_ASYNC_IO = 1;
pub const _LFS_ASYNCHRONOUS_IO = 1;
pub const _POSIX_PRIORITIZED_IO = 200809;
pub const _LFS64_ASYNCHRONOUS_IO = 1;
pub const _LFS_LARGEFILE = 1;
pub const _LFS64_LARGEFILE = 1;
pub const _LFS64_STDIO = 1;
pub const _POSIX_SHARED_MEMORY_OBJECTS = 200809;
pub const _POSIX_CPUTIME = 0;
pub const _POSIX_THREAD_CPUTIME = 0;
pub const _POSIX_REGEXP = 1;
pub const _POSIX_READER_WRITER_LOCKS = 200809;
pub const _POSIX_SHELL = 1;
pub const _POSIX_TIMEOUTS = 200809;
pub const _POSIX_SPIN_LOCKS = 200809;
pub const _POSIX_SPAWN = 200809;
pub const _POSIX_TIMERS = 200809;
pub const _POSIX_BARRIERS = 200809;
pub const _POSIX_MESSAGE_PASSING = 200809;
pub const _POSIX_THREAD_PROCESS_SHARED = 200809;
pub const _POSIX_MONOTONIC_CLOCK = 0;
pub const _POSIX_CLOCK_SELECTION = 200809;
pub const _POSIX_ADVISORY_INFO = 200809;
pub const _POSIX_IPV6 = 200809;
pub const _POSIX_RAW_SOCKETS = 200809;
pub const _POSIX2_CHAR_TERM = 200809;
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/unistd.h:1134:10
pub const _LINUX_CLOSE_RANGE_H = "";
pub const CLOSE_RANGE_UNSHARE = 1 << 1;
pub const CLOSE_RANGE_CLOEXEC = 1 << 2;
...
pub const __GLIBC_USE_LIB_EXT2 = 1;
pub const __GLIBC_USE_IEC_60559_BFP_EXT = 1;
pub const __GLIBC_USE_IEC_60559_BFP_EXT_C2X = 1;
pub const __GLIBC_USE_IEC_60559_EXT = 1;
pub const __GLIBC_USE_IEC_60559_FUNCS_EXT = 1;
pub const __GLIBC_USE_IEC_60559_FUNCS_EXT_C2X = 1;
pub const __GLIBC_USE_IEC_60559_TYPES_EXT = 1;
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/struct_FILE.h:102:9
pub const __putc_unlocked_body = @compileError("TODO postfix inc/dec expr");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/types/struct_FILE.h:106:9
...
pub const __cookie_io_functions_t_defined = 1;
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:149:12
pub const __CFLOAT64 = @compileError("unable to translate: TODO _Complex");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:160:13
pub const __CFLOAT32X = @compileError("unable to translate: TODO _Complex");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:169:12
pub const __CFLOAT64X = @compileError("unable to translate: TODO _Complex");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:178:13
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:221:12
pub const __builtin_huge_valf64 = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:255:13
pub const __builtin_inff64 = @compileError("unable to translate macro: undefined identifier `__builtin_inf`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:256:13
pub const __builtin_nanf64 = @compileError("unable to translate macro: undefined identifier `__builtin_nan`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:257:13
pub const __builtin_nansf64 = @compileError("unable to translate macro: undefined identifier `__builtin_nans`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:258:13
pub const __builtin_huge_valf32x = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:272:12
pub const __builtin_inff32x = @compileError("unable to translate macro: undefined identifier `__builtin_inf`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:273:12
pub const __builtin_nanf32x = @compileError("unable to translate macro: undefined identifier `__builtin_nan`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:274:12
pub const __builtin_nansf32x = @compileError("unable to translate macro: undefined identifier `__builtin_nans`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:275:12
pub const __builtin_huge_valf64x = @compileError("unable to translate macro: undefined identifier `__builtin_huge_vall`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:289:13
pub const __builtin_inff64x = @compileError("unable to translate macro: undefined identifier `__builtin_infl`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:290:13
pub const __builtin_nanf64x = @compileError("unable to translate macro: undefined identifier `__builtin_nanl`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:291:13
pub const __builtin_nansf64x = @compileError("unable to translate macro: undefined identifier `__builtin_nansl`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/bits/floatn-common.h:292:13
...
pub inline fn __isascii(c: anytype) @TypeOf((c & ~@as(c_int, 0x7f)) == 0) {
    return (c & ~@as(c_int, 0x7f)) == 0;
}
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/ctype.h:102:9
pub const __tobody = @compileError("unable to translate macro: undefined identifier `__res`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/ctype.h:155:9
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/ctype.h:244:10
...
pub const _SYS_TIMEB_H = 1;
pub const __timeb_defined = 1;
pub const _SYS_TIME_H = 1;
pub const TIMEVAL_TO_TIMESPEC = @compileError("unable to translate C expr: unexpected token '{'");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/sys/time.h:38:10
pub const TIMESPEC_TO_TIMEVAL = @compileError("unable to translate C expr: unexpected token '{'");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/sys/time.h:42:10
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/sys/time.h:232:10
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/sys/time.h:237:10
pub const timersub = @compileError("unable to translate C expr: unexpected token 'do'");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/sys/time.h:247:10
pub const _TIME_H = 1;
...
pub inline fn __isleap(year: anytype) @TypeOf((@import("std").zig.c_translation.MacroArithmetic.rem(year, 4) == 0) and ((@import("std").zig.c_translation.MacroArithmetic.rem(year, 100) != 0) or (@import("std").zig.c_translation.MacroArithmetic.rem(year, 400) == 0))) {
    return (@import("std").zig.c_translation.MacroArithmetic.rem(year, 4) == 0) and ((@import("std").zig.c_translation.MacroArithmetic.rem(year, 100) != 0) or (@import("std").zig.c_translation.MacroArithmetic.rem(year, 400) == 0));
}
...
pub const SCHAR_WIDTH = 8;
pub const UCHAR_WIDTH = 8;
pub const SHRT_WIDTH = 16;
pub const USHRT_WIDTH = 16;
pub const INT_WIDTH = 32;
pub const UINT_WIDTH = 32;
pub const LONG_WIDTH = __WORDSIZE;
pub const ULONG_WIDTH = __WORDSIZE;
pub const LLONG_WIDTH = 64;
pub const ULLONG_WIDTH = 64;
pub const BOOL_MAX = 1;
pub const BOOL_WIDTH = 1;
...
pub const _POSIX_QLIMIT = 1;
pub const _POSIX_HIWAT = _POSIX_PIPE_BUF;
pub const _POSIX_UIO_MAXIOV = 16;
...
pub const __SC_THREAD_STACK_MIN_VALUE = 75;
...
pub const LONG_MIN = -__LONG_MAX__ - 1;
pub const UCHAR_MAX = (__SCHAR_MAX__ * 2) + 1;
pub const USHRT_MAX = (__SHRT_MAX__ * 2) + 1;
pub const UINT_MAX = (__INT_MAX__ * 2) + 1;
pub const ULONG_MAX = (__LONG_MAX__ * 2) + 1;
...
pub const _SYS_PARAM_H = 1;
pub const _LINUX_PARAM_H = "";
pub const __ASM_GENERIC_PARAM_H = "";
pub const HZ = 100;
pub const EXEC_PAGESIZE = 4096;
pub const NOGROUP = -1;
pub const MAXHOSTNAMELEN = 64;
pub const MAXSYMLINKS = 20;
pub const NOFILE = 256;
...
pub const NODEV = @import("std").zig.c_translation.cast(dev_t, -1);
pub const DEV_BSIZE = 512;
pub const setbit = @compileError("unable to translate C expr: expected ')' instead got '|='");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/sys/param.h:83:9
pub const clrbit = @compileError("unable to translate C expr: expected ')' instead got '&='");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/sys/param.h:84:9
pub inline fn isset(a: anytype, i: anytype) @TypeOf(a[@as(usize, @intCast(@import("std").zig.c_translation.MacroArithmetic.div(i, NBBY)))] & (1 << @import("std").zig.c_translation.MacroArithmetic.rem(i, NBBY))) {
    return a[@as(usize, @intCast(@import("std").zig.c_translation.MacroArithmetic.div(i, NBBY)))] & (1 << @import("std").zig.c_translation.MacroArithmetic.rem(i, NBBY));
}
pub inline fn isclr(a: anytype, i: anytype) @TypeOf((a[@as(usize, @intCast(@import("std").zig.c_translation.MacroArithmetic.div(i, NBBY)))] & (1 << @import("std").zig.c_translation.MacroArithmetic.rem(i, NBBY))) == 0) {
    return (a[@as(usize, @intCast(@import("std").zig.c_translation.MacroArithmetic.div(i, NBBY)))] & (1 << @import("std").zig.c_translation.MacroArithmetic.rem(i, NBBY))) == 0;
}
pub inline fn howmany(x: anytype, y: anytype) @TypeOf(@import("std").zig.c_translation.MacroArithmetic.div(x + (y - 1), y)) {
    return @import("std").zig.c_translation.MacroArithmetic.div(x + (y - 1), y);
}
pub inline fn roundup(x: anytype, y: anytype) @TypeOf(if ((__builtin_constant_p(y) != 0) and (powerof2(y) != 0)) ((x + y) - 1) & ~(y - 1) else @import("std").zig.c_translation.MacroArithmetic.div(x + (y - 1), y) * y) {
    return if ((__builtin_constant_p(y) != 0) and (powerof2(y) != 0)) ((x + y) - 1) & ~(y - 1) else @import("std").zig.c_translation.MacroArithmetic.div(x + (y - 1), y) * y;
}
pub inline fn powerof2(x: anytype) @TypeOf(((x - 1) & x) == 0) {
    return ((x - 1) & x) == 0;
}
...
pub inline fn PATH_VAR(@"var": anytype) @TypeOf(u8 ++ @"var"[@as(usize, @intCast(PATH_MAX + 1))]) {
    _ = &@"var";
    return u8 ++ @"var"[@as(usize, @intCast(PATH_MAX + 1))];
}
pub inline fn INTEGER_TYPE_SIGNED(t: anytype) @TypeOf((t - 1) <= 0) {
    return (t - 1) <= 0;
}
...
pub inline fn __WEXITSTATUS(status: anytype) @TypeOf((status & @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff00, .hex)) >> 8) {
    return (status & @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff00, .hex)) >> 8;
}
...
pub inline fn __WIFSIGNALED(status: anytype) @TypeOf((@import("std").zig.c_translation.cast(i8, (status & @as(c_int, 0x7f)) + 1) >> 1) > 0) {
    return (@import("std").zig.c_translation.cast(i8, (status & @as(c_int, 0x7f)) + 1) >> 1) > 0;
}
...
pub inline fn __W_STOPCODE(sig: anytype) @TypeOf((sig << 8) | @as(c_int, 0x7f)) {
    return (sig << 8) | @as(c_int, 0x7f);
}
...
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/string.h:201:10
pub const strndupa = @compileError("unable to translate macro: undefined identifier `__old`");
// /nix/store/1l5gb4773rbqjzv49wb4h9xlmaz2zs5h-zig-0.13.0/lib/zig/libc/include/generic-glibc/string.h:211:10
pub const _STRINGS_H = 1;
pub const ANSI_STRING = 1;
...
pub const _BITS_STDINT_LEAST_H = 1;
pub const __INT64_C = @import("std").zig.c_translation.Macros.L_SUFFIX;
pub const __UINT64_C = @import("std").zig.c_translation.Macros.UL_SUFFIX;
pub const INT8_MIN = -128;
pub const INT16_MIN = -32767 - 1;
pub const INT32_MIN = -@import("std").zig.c_translation.promoteIntLiteral(c_int, 2147483647, .decimal) - 1;
pub const INT64_MIN = -__INT64_C(@import("std").zig.c_translation.promoteIntLiteral(c_int, 9223372036854775807, .decimal)) - 1;
...
pub const INT_LEAST32_MIN = -@import("std").zig.c_translation.promoteIntLiteral(c_int, 2147483647, .decimal) - 1;
pub const INT_LEAST64_MIN = -__INT64_C(@import("std").zig.c_translation.promoteIntLiteral(c_int, 9223372036854775807, .decimal)) - 1;
...
pub const INT_FAST16_MIN = -@import("std").zig.c_translation.promoteIntLiteral(c_long, 9223372036854775807, .decimal) - 1;
pub const INT_FAST32_MIN = -@import("std").zig.c_translation.promoteIntLiteral(c_long, 9223372036854775807, .decimal) - 1;
pub const INT_FAST64_MIN = -__INT64_C(@import("std").zig.c_translation.promoteIntLiteral(c_int, 9223372036854775807, .decimal)) - 1;
...
pub const INTPTR_MIN = -@import("std").zig.c_translation.promoteIntLiteral(c_long, 9223372036854775807, .decimal) - 1;
pub const INTPTR_MAX = @import("std").zig.c_translation.promoteIntLiteral(c_long, 9223372036854775807, .decimal);
pub const UINTPTR_MAX = @import("std").zig.c_translation.promoteIntLiteral(c_ulong, 18446744073709551615, .decimal);
pub const INTMAX_MIN = -__INT64_C(@import("std").zig.c_translation.promoteIntLiteral(c_int, 9223372036854775807, .decimal)) - 1;
pub const INTMAX_MAX = __INT64_C(@import("std").zig.c_translation.promoteIntLiteral(c_int, 9223372036854775807, .decimal));
pub const UINTMAX_MAX = __UINT64_C(@import("std").zig.c_translation.promoteIntLiteral(c_int, 18446744073709551615, .decimal));
pub const PTRDIFF_MIN = -@import("std").zig.c_translation.promoteIntLiteral(c_long, 9223372036854775807, .decimal) - 1;
pub const PTRDIFF_MAX = @import("std").zig.c_translation.promoteIntLiteral(c_long, 9223372036854775807, .decimal);
pub const SIG_ATOMIC_MIN = -@import("std").zig.c_translation.promoteIntLiteral(c_int, 2147483647, .decimal) - 1;
...
pub const INT8_WIDTH = 8;
pub const UINT8_WIDTH = 8;
pub const INT16_WIDTH = 16;
pub const UINT16_WIDTH = 16;
pub const INT32_WIDTH = 32;
pub const UINT32_WIDTH = 32;
pub const INT64_WIDTH = 64;
pub const UINT64_WIDTH = 64;
pub const INT_LEAST8_WIDTH = 8;
pub const UINT_LEAST8_WIDTH = 8;
pub const INT_LEAST16_WIDTH = 16;
pub const UINT_LEAST16_WIDTH = 16;
pub const INT_LEAST32_WIDTH = 32;
pub const UINT_LEAST32_WIDTH = 32;
pub const INT_LEAST64_WIDTH = 64;
pub const UINT_LEAST64_WIDTH = 64;
pub const INT_FAST8_WIDTH = 8;
pub const UINT_FAST8_WIDTH = 8;
...
pub const INT_FAST64_WIDTH = 64;
pub const UINT_FAST64_WIDTH = 64;
pub const INTPTR_WIDTH = __WORDSIZE;
pub const UINTPTR_WIDTH = __WORDSIZE;
pub const INTMAX_WIDTH = 64;
pub const UINTMAX_WIDTH = 64;
pub const PTRDIFF_WIDTH = __WORDSIZE;
pub const SIG_ATOMIC_WIDTH = 32;
pub const SIZE_WIDTH = __WORDSIZE;
pub const WCHAR_WIDTH = 32;
pub const WINT_WIDTH = 32;
...
pub inline fn ISDIGIT(c: anytype) @TypeOf((@import("std").zig.c_translation.cast(c_uint, c) - '0') <= 9) {
    return (@import("std").zig.c_translation.cast(c_uint, c) - '0') <= 9;
}
pub inline fn streq(a: anytype, b: anytype) @TypeOf((a == b) or ((a.* == b.*) and ((a.* == '\x00') or !(strcmp(a + 1, b + 1) != 0)))) {
    return (a == b) or ((a.* == b.*) and ((a.* == '\x00') or !(strcmp(a + 1, b + 1) != 0)));
}
pub inline fn patheq(a: anytype, b: anytype) @TypeOf(streq(a, b)) {
    return streq(a, b);
}
pub inline fn strneq(a: anytype, b: anytype, l: anytype) @TypeOf(strncmp(a, b, l) == 0) {
...
pub const _LOCALE_H = 1;
pub const _BITS_LOCALE_H = 1;
pub const __LC_CTYPE = 0;
pub const __LC_NUMERIC = 1;
pub const __LC_TIME = 2;
pub const __LC_COLLATE = 3;
pub const __LC_MONETARY = 4;
pub const __LC_MESSAGES = 5;
pub const __LC_ALL = 6;
pub const __LC_PAPER = 7;
pub const __LC_NAME = 8;
pub const __LC_ADDRESS = 9;
pub const __LC_TELEPHONE = 10;
pub const __LC_MEASUREMENT = 11;
pub const __LC_IDENTIFICATION = 12;
...
pub const LC_CTYPE_MASK = 1 << __LC_CTYPE;
pub const LC_NUMERIC_MASK = 1 << __LC_NUMERIC;
pub const LC_TIME_MASK = 1 << __LC_TIME;
pub const LC_COLLATE_MASK = 1 << __LC_COLLATE;
pub const LC_MONETARY_MASK = 1 << __LC_MONETARY;
pub const LC_MESSAGES_MASK = 1 << __LC_MESSAGES;
pub const LC_PAPER_MASK = 1 << __LC_PAPER;
pub const LC_NAME_MASK = 1 << __LC_NAME;
pub const LC_ADDRESS_MASK = 1 << __LC_ADDRESS;
pub const LC_TELEPHONE_MASK = 1 << __LC_TELEPHONE;
pub const LC_MEASUREMENT_MASK = 1 << __LC_MEASUREMENT;
pub const LC_IDENTIFICATION_MASK = 1 << __LC_IDENTIFICATION;
...
pub const LC_GLOBAL_LOCALE = @import("std").zig.c_translation.cast(locale_t, -1);
pub const _LIBGETTEXT_H = 1;
pub const _LIBINTL_H = 1;
pub const __USE_GNU_GETTEXT = 1;
pub inline fn __GNU_GETTEXT_SUPPORTED_REVISION(major: anytype) @TypeOf(if (major == 0) 1 else -1) {
    return if (major == 0) 1 else -1;
}
...
pub inline fn ANY_SET(_v: anytype, _m: anytype) @TypeOf((_v & _m) != 0) {
    return (_v & _m) != 0;
}
...
pub inline fn HAS_DRIVESPEC(_s: anytype) @TypeOf(0) {
    return 0;
}
pub const _GLOB_H = 1;
pub const GLOB_ERR = 1 << 0;
pub const GLOB_MARK = 1 << 1;
pub const GLOB_NOSORT = 1 << 2;
pub const GLOB_DOOFFS = 1 << 3;
pub const GLOB_NOCHECK = 1 << 4;
pub const GLOB_APPEND = 1 << 5;
pub const GLOB_NOESCAPE = 1 << 6;
pub const GLOB_PERIOD = 1 << 7;
pub const GLOB_MAGCHAR = 1 << 8;
pub const GLOB_ALTDIRFUNC = 1 << 9;
pub const GLOB_BRACE = 1 << 10;
pub const GLOB_NOMAGIC = 1 << 11;
pub const GLOB_TILDE = 1 << 12;
pub const GLOB_ONLYDIR = 1 << 13;
pub const GLOB_TILDE_CHECK = 1 << 14;
...
pub const GLOB_NOSYS = 4;
pub const GLOB_ABEND = GLOB_ABORTED;
pub const NILF = @import("std").zig.c_translation.cast([*c]floc, 0);
pub inline fn CSTRLEN(_s: anytype) @TypeOf(@import("std").zig.c_translation.sizeof(_s) - 1) {
    return @import("std").zig.c_translation.sizeof(_s) - 1;
}
...
pub const INTSTR_LENGTH = @import("std").zig.c_translation.MacroArithmetic.div(53 * @import("std").zig.c_translation.sizeof(uintmax_t), 22) + 3;
pub const DEFAULT_TTYNAME = "true";
pub inline fn TTYNAME(_f: anytype) @TypeOf(ttyname(_f)) {
    return ttyname(_f);
}
pub const DEFAULT_TMPDIR = P_tmpdir;
pub inline fn O(_t: anytype, _a: anytype, _f: anytype) @TypeOf(_t(_a, 0, _f)) {
    return _t(_a, 0, _f);
}
...
pub inline fn ONN(_t: anytype, _a: anytype, _f: anytype, _n1: anytype, _n2: anytype) @TypeOf(_t(_a, INTSTR_LENGTH * 2, _f, _n1, _n2)) {
    return _t(_a, INTSTR_LENGTH * 2, _f, _n1, _n2);
}
...
pub inline fn xstrlen(_s: anytype) @TypeOf(if (_s == NULL) 0 else strlen(_s)) {
    return if (_s == NULL) 0 else strlen(_s);
}
...
pub const JOBSERVER_USE_FIFO = 1;
pub const JOBSERVER_AUTH_OPT = "jobserver-auth";
pub const MAKE_SUCCESS = 0;
pub const MAKE_TROUBLE = 1;
pub const MAKE_FAILURE = 2;
...
// src/makeint.h:883:9
pub const _hash_h_ = "";
pub inline fn HASH_VACANT(item: anytype) @TypeOf((item == 0) or (@import("std").zig.c_translation.cast(?*anyopaque, item) == hash_deleted_item)) {
    return (item == 0) or (@import("std").zig.c_translation.cast(?*anyopaque, item) == hash_deleted_item);
}
...
// src/hash.h:219:9
pub inline fn ADDRESS_HASH_1(KEY: anytype, RESULT: anytype) @TypeOf(INTEGER_HASH_1(@import("std").zig.c_translation.cast(c_ulong, KEY) >> 3, RESULT)) {
    return INTEGER_HASH_1(@import("std").zig.c_translation.cast(c_ulong, KEY) >> 3, RESULT);
}
pub inline fn ADDRESS_HASH_2(KEY: anytype, RESULT: anytype) @TypeOf(INTEGER_HASH_2(@import("std").zig.c_translation.cast(c_ulong, KEY) >> 3, RESULT)) {
    return INTEGER_HASH_2(@import("std").zig.c_translation.cast(c_ulong, KEY) >> 3, RESULT);
}
...
pub inline fn return_ADDRESS_HASH_1(KEY: anytype) @TypeOf(return_INTEGER_HASH_1(@import("std").zig.c_translation.cast(c_ulong, KEY) >> 3)) {
    return return_INTEGER_HASH_1(@import("std").zig.c_translation.cast(c_ulong, KEY) >> 3);
}
pub inline fn return_ADDRESS_HASH_2(KEY: anytype) @TypeOf(return_INTEGER_HASH_2(@import("std").zig.c_translation.cast(c_ulong, KEY) >> 3)) {
    return return_INTEGER_HASH_2(@import("std").zig.c_translation.cast(c_ulong, KEY) >> 3);
}
...
pub const FILE_TIMESTAMPS_PER_S = if (FILE_TIMESTAMP_HI_RES) @import("std").zig.c_translation.promoteIntLiteral(c_int, 1000000000, .decimal) else 1;
pub const FILE_TIMESTAMP_LO_BITS = if (FILE_TIMESTAMP_HI_RES) 30 else 0;
...
pub inline fn FILE_TIMESTAMP_NS(ts: anytype) c_int {
    return @import("std").zig.c_translation.cast(c_int, (ts - ORDINARY_MTIME_MIN) & ((1 << FILE_TIMESTAMP_LO_BITS) - 1));
}
pub const FLOOR_LOG2_SECONDS_PER_YEAR = 24;
pub const FILE_TIMESTAMP_PRINT_LEN_BOUND = (((@import("std").zig.c_translation.MacroArithmetic.div((((@import("std").zig.c_translation.sizeof(FILE_TIMESTAMP) * CHAR_BIT) - 1) - FLOOR_LOG2_SECONDS_PER_YEAR) * 302, 1000) + 1) + 1) + 4) + 25;
pub inline fn file_mtime(f: anytype) @TypeOf(file_mtime_1(f, 1)) {
    return file_mtime_1(f, 1);
}
pub inline fn file_mtime_no_search(f: anytype) @TypeOf(file_mtime_1(f, 0)) {
    return file_mtime_1(f, 0);
}
...
pub const UNKNOWN_MTIME = 0;
pub const NONEXISTENT_MTIME = 1;
pub const OLD_MTIME = 2;
pub const ORDINARY_MTIME_MIN = OLD_MTIME + 1;
pub const ORDINARY_MTIME_MAX = (((FILE_TIMESTAMP_S(NEW_MTIME) << FILE_TIMESTAMP_LO_BITS) + ORDINARY_MTIME_MIN) + FILE_TIMESTAMPS_PER_S) - 1;
...
// src/dep.h:20:9
pub const RM_NOFLAG = 0;
pub const RM_NO_DEFAULT_GOAL = 1 << 0;
pub const RM_INCLUDED = 1 << 1;
pub const RM_DONTCARE = 1 << 2;
pub const RM_NO_TILDE = 1 << 3;
...
pub const _FNMATCH_H = 1;
pub const FNM_PATHNAME = 1 << 0;
pub const FNM_NOESCAPE = 1 << 1;
pub const FNM_PERIOD = 1 << 2;
pub const FNM_FILE_NAME = FNM_PATHNAME;
pub const FNM_LEADING_DIR = 1 << 3;
pub const FNM_CASEFOLD = 1 << 4;
pub const FNM_EXTMATCH = 1 << 5;
pub const FNM_NOMATCH = 1;
pub const FNM_NOSYS = -1;
pub const _GL_INTPROPS_H = "";
pub const _GL_INTPROPS_INTERNAL_H = "";
pub inline fn _GL_INT_CONVERT(e: anytype, v: anytype) @TypeOf((if (1) 0 else e) + v) {
    return (if (1) 0 else e) + v;
}
pub inline fn _GL_INT_NEGATE_CONVERT(e: anytype, v: anytype) @TypeOf((if (1) 0 else e) - v) {
    return (if (1) 0 else e) - v;
}
pub const _GL_TYPE_SIGNED = @compileError("unable to translate C expr: expected ')' instead got 'A number'");
// lib/intprops-internal.h:35:9
pub inline fn _GL_EXPR_SIGNED(e: anytype) @TypeOf(_GL_INT_NEGATE_CONVERT(e, 1) < 0) {
    return _GL_INT_NEGATE_CONVERT(e, 1) < 0;
}
pub inline fn _GL_TYPE_WIDTH(t: anytype) @TypeOf(@import("std").zig.c_translation.sizeof(t) * CHAR_BIT) {
    return @import("std").zig.c_translation.sizeof(t) * CHAR_BIT;
}
pub inline fn _GL_INT_MINIMUM(e: anytype) @TypeOf(if (_GL_EXPR_SIGNED(e)) ~_GL_SIGNED_INT_MAXIMUM(e) else _GL_INT_CONVERT(e, 0)) {
    return if (_GL_EXPR_SIGNED(e)) ~_GL_SIGNED_INT_MAXIMUM(e) else _GL_INT_CONVERT(e, 0);
}
pub inline fn _GL_INT_MAXIMUM(e: anytype) @TypeOf(if (_GL_EXPR_SIGNED(e)) _GL_SIGNED_INT_MAXIMUM(e) else _GL_INT_NEGATE_CONVERT(e, 1)) {
    return if (_GL_EXPR_SIGNED(e)) _GL_SIGNED_INT_MAXIMUM(e) else _GL_INT_NEGATE_CONVERT(e, 1);
}
pub inline fn _GL_SIGNED_INT_MAXIMUM(e: anytype) @TypeOf((((_GL_INT_CONVERT(e, 1) << (_GL_TYPE_WIDTH(e) - 2)) - 1) * 2) + 1) {
    return (((_GL_INT_CONVERT(e, 1) << (_GL_TYPE_WIDTH(e) - 2)) - 1) * 2) + 1;
}
pub const _GL_HAVE___TYPEOF__ = 1;
pub const _GL_SIGNED_TYPE_OR_EXPR = @compileError("unable to translate C expr: unexpected token '__typeof__'");
// lib/intprops-internal.h:89:10
pub inline fn _GL_INT_NEGATE_RANGE_OVERFLOW(a: anytype, min: anytype, max: anytype) @TypeOf(if (min < 0) a < -max else 0 < a) {
    return if (min < 0) a < -max else 0 < a;
}
pub const _GL_HAS_BUILTIN_ADD_OVERFLOW = @compileError("unable to translate macro: undefined identifier `__builtin_add_overflow`");
// lib/intprops-internal.h:107:10
pub const _GL_HAS_BUILTIN_MUL_OVERFLOW = _GL_HAS_BUILTIN_ADD_OVERFLOW;
pub const _GL_HAS_BUILTIN_OVERFLOW_P = @compileError("unable to translate macro: undefined identifier `__builtin_mul_overflow_p`");
// lib/intprops-internal.h:132:10
pub const _GL_INT_ADD_WRAPV = @compileError("unable to translate macro: undefined identifier `__builtin_add_overflow`");
// lib/intprops-internal.h:147:10
pub const _GL_INT_SUBTRACT_WRAPV = @compileError("unable to translate macro: undefined identifier `__builtin_sub_overflow`");
// lib/intprops-internal.h:148:10
pub const _GL_INT_MULTIPLY_WRAPV = @compileError("unable to translate C expr: unexpected token '__typeof__'");
// lib/intprops-internal.h:165:11
pub const _GL__GENERIC_BOGUS = 1;
pub const _GL_INT_OP_WRAPV_SMALLISH = @compileError("unable to translate C expr: unexpected token '__typeof__'");
// lib/intprops-internal.h:238:11
pub inline fn _GL_INT_OP_WRAPV(a: anytype, b: anytype, r: anytype, op: anytype, overflow: anytype) @TypeOf(if (@import("std").zig.c_translation.sizeof(r.*) == @import("std").zig.c_translation.sizeof(i8)) _GL_INT_OP_WRAPV_SMALLISH(a, b, r, op, overflow, i8, SCHAR_MIN, SCHAR_MAX, u8, UCHAR_MAX) else if (@import("std").zig.c_translation.sizeof(r.*) == @import("std").zig.c_translation.sizeof(c_short)) _GL_INT_OP_WRAPV_SMALLISH(a, b, r, op, overflow, c_short, SHRT_MIN, SHRT_MAX, c_ushort, USHRT_MAX) else if (@import("std").zig.c_translation.sizeof(r.*) == @import("std").zig.c_translation.sizeof(c_int)) if (_GL_EXPR_SIGNED(r.*)) _GL_INT_OP_CALC(a, b, r, op, overflow, c_uint, c_int, INT_MIN, INT_MAX) else _GL_INT_OP_CALC(a, b, r, op, overflow, c_uint, c_uint, 0, UINT_MAX) else _GL_INT_OP_WRAPV_LONGISH(a, b, r, op, overflow)) {
    return if (@import("std").zig.c_translation.sizeof(r.*) == @import("std").zig.c_translation.sizeof(i8)) _GL_INT_OP_WRAPV_SMALLISH(a, b, r, op, overflow, i8, SCHAR_MIN, SCHAR_MAX, u8, UCHAR_MAX) else if (@import("std").zig.c_translation.sizeof(r.*) == @import("std").zig.c_translation.sizeof(c_short)) _GL_INT_OP_WRAPV_SMALLISH(a, b, r, op, overflow, c_short, SHRT_MIN, SHRT_MAX, c_ushort, USHRT_MAX) else if (@import("std").zig.c_translation.sizeof(r.*) == @import("std").zig.c_translation.sizeof(c_int)) if (_GL_EXPR_SIGNED(r.*)) _GL_INT_OP_CALC(a, b, r, op, overflow, c_uint, c_int, INT_MIN, INT_MAX) else _GL_INT_OP_CALC(a, b, r, op, overflow, c_uint, c_uint, 0, UINT_MAX) else _GL_INT_OP_WRAPV_LONGISH(a, b, r, op, overflow);
}
pub inline fn _GL_INT_OP_WRAPV_LONGISH(a: anytype, b: anytype, r: anytype, op: anytype, overflow: anytype) @TypeOf(if (@import("std").zig.c_translation.sizeof(r.*) == @import("std").zig.c_translation.sizeof(c_long)) if (_GL_EXPR_SIGNED(r.*)) _GL_INT_OP_CALC(a, b, r, op, overflow, c_ulong, c_long, LONG_MIN, LONG_MAX) else _GL_INT_OP_CALC(a, b, r, op, overflow, c_ulong, c_ulong, 0, ULONG_MAX) else if (_GL_EXPR_SIGNED(r.*)) _GL_INT_OP_CALC(a, b, r, op, overflow, c_ulonglong, c_longlong, LLONG_MIN, LLONG_MAX) else _GL_INT_OP_CALC(a, b, r, op, overflow, c_ulonglong, c_ulonglong, 0, ULLONG_MAX)) {
    return if (@import("std").zig.c_translation.sizeof(r.*) == @import("std").zig.c_translation.sizeof(c_long)) if (_GL_EXPR_SIGNED(r.*)) _GL_INT_OP_CALC(a, b, r, op, overflow, c_ulong, c_long, LONG_MIN, LONG_MAX) else _GL_INT_OP_CALC(a, b, r, op, overflow, c_ulong, c_ulong, 0, ULONG_MAX) else if (_GL_EXPR_SIGNED(r.*)) _GL_INT_OP_CALC(a, b, r, op, overflow, c_ulonglong, c_longlong, LLONG_MIN, LLONG_MAX) else _GL_INT_OP_CALC(a, b, r, op, overflow, c_ulonglong, c_ulonglong, 0, ULLONG_MAX);
}
pub const _GL_INT_OP_CALC = @compileError("unable to translate C expr: expected ')' instead got '='");
// lib/intprops-internal.h:298:9
pub inline fn _GL_INT_NEGATE_OVERFLOW(a: anytype) @TypeOf(_GL_INT_NEGATE_RANGE_OVERFLOW(a, _GL_INT_MINIMUM(a), _GL_INT_MAXIMUM(a))) {
    return _GL_INT_NEGATE_RANGE_OVERFLOW(a, _GL_INT_MINIMUM(a), _GL_INT_MAXIMUM(a));
}
pub inline fn _GL_INT_OP_WRAPV_VIA_UNSIGNED(a: anytype, b: anytype, op: anytype, ut: anytype, t: anytype) @TypeOf(t(ut(a) ++ op(ut)(b))) {
    return t(ut(a) ++ op(ut)(b));
}
pub inline fn _GL_INT_ADD_RANGE_OVERFLOW(a: anytype, b: anytype, tmin: anytype, tmax: anytype) @TypeOf(if (b < 0) ((if (tmin) ((_GL_EXPR_SIGNED(_GL_INT_CONVERT(a, tmin - b)) != 0) or (b < tmin)) and (a < (tmin - b)) else a <= (-1 - b)) != 0) or (((if (_GL_EXPR_SIGNED(a)) 0 <= a else tmax < a) != 0) and (tmax < (a + b))) else if (a < 0) ((if (tmin) ((_GL_EXPR_SIGNED(_GL_INT_CONVERT(b, tmin - a)) != 0) or (a < tmin)) and (b < (tmin - a)) else b <= (-1 - a)) != 0) or (((_GL_EXPR_SIGNED(_GL_INT_CONVERT(a, b)) != 0) or (tmax < b)) and (tmax < (a + b))) else (tmax < b) or ((tmax - b) < a)) {
    return if (b < 0) ((if (tmin) ((_GL_EXPR_SIGNED(_GL_INT_CONVERT(a, tmin - b)) != 0) or (b < tmin)) and (a < (tmin - b)) else a <= (-1 - b)) != 0) or (((if (_GL_EXPR_SIGNED(a)) 0 <= a else tmax < a) != 0) and (tmax < (a + b))) else if (a < 0) ((if (tmin) ((_GL_EXPR_SIGNED(_GL_INT_CONVERT(b, tmin - a)) != 0) or (a < tmin)) and (b < (tmin - a)) else b <= (-1 - a)) != 0) or (((_GL_EXPR_SIGNED(_GL_INT_CONVERT(a, b)) != 0) or (tmax < b)) and (tmax < (a + b))) else (tmax < b) or ((tmax - b) < a);
}
pub inline fn _GL_INT_SUBTRACT_RANGE_OVERFLOW(a: anytype, b: anytype, tmin: anytype, tmax: anytype) @TypeOf(if (@intFromBool(a < 0) == @intFromBool(b < 0)) if (a < b) !(tmin != 0) or ((-1 - tmin) < ((b - a) - 1)) else tmax < (a - b) else if (a < 0) (!(_GL_EXPR_SIGNED(_GL_INT_CONVERT(a - tmin, b)) != 0) and ((a - tmin) < 0)) or ((a - tmin) < b) else (!((_GL_EXPR_SIGNED(_GL_INT_CONVERT(tmax, b)) != 0) and (_GL_EXPR_SIGNED(_GL_INT_CONVERT(tmax + b, a)) != 0)) and (tmax <= (-1 - b))) or ((tmax + b) < a)) {
    return if (@intFromBool(a < 0) == @intFromBool(b < 0)) if (a < b) !(tmin != 0) or ((-1 - tmin) < ((b - a) - 1)) else tmax < (a - b) else if (a < 0) (!(_GL_EXPR_SIGNED(_GL_INT_CONVERT(a - tmin, b)) != 0) and ((a - tmin) < 0)) or ((a - tmin) < b) else (!((_GL_EXPR_SIGNED(_GL_INT_CONVERT(tmax, b)) != 0) and (_GL_EXPR_SIGNED(_GL_INT_CONVERT(tmax + b, a)) != 0)) and (tmax <= (-1 - b))) or ((tmax + b) < a);
}
pub inline fn _GL_INT_MULTIPLY_RANGE_OVERFLOW(a: anytype, b: anytype, tmin: anytype, tmax: anytype) @TypeOf(if (b < 0) if (a < 0) if (_GL_EXPR_SIGNED(_GL_INT_CONVERT(tmax, b))) a < @import("std").zig.c_translation.MacroArithmetic.div(tmax, b) else (if (_GL_INT_NEGATE_OVERFLOW(b)) _GL_INT_CONVERT(b, tmax) >> (_GL_TYPE_WIDTH(b) - 1) else @import("std").zig.c_translation.MacroArithmetic.div(tmax, -b)) <= (-1 - a) else if ((_GL_INT_NEGATE_OVERFLOW(_GL_INT_CONVERT(b, tmin)) != 0) and (b == -1)) if (_GL_EXPR_SIGNED(a)) 0 < (a + tmin) else (0 < a) and ((-1 - tmin) < (a - 1)) else @import("std").zig.c_translation.MacroArithmetic.div(tmin, b) < a else if (b == 0) 0 else if (a < 0) if ((_GL_INT_NEGATE_OVERFLOW(_GL_INT_CONVERT(a, tmin)) != 0) and (a == -1)) if (_GL_EXPR_SIGNED(b)) 0 < (b + tmin) else (-1 - tmin) < (b - 1) else @import("std").zig.c_translation.MacroArithmetic.div(tmin, a) < b else @import("std").zig.c_translation.MacroArithmetic.div(tmax, b) < a) {
    return if (b < 0) if (a < 0) if (_GL_EXPR_SIGNED(_GL_INT_CONVERT(tmax, b))) a < @import("std").zig.c_translation.MacroArithmetic.div(tmax, b) else (if (_GL_INT_NEGATE_OVERFLOW(b)) _GL_INT_CONVERT(b, tmax) >> (_GL_TYPE_WIDTH(b) - 1) else @import("std").zig.c_translation.MacroArithmetic.div(tmax, -b)) <= (-1 - a) else if ((_GL_INT_NEGATE_OVERFLOW(_GL_INT_CONVERT(b, tmin)) != 0) and (b == -1)) if (_GL_EXPR_SIGNED(a)) 0 < (a + tmin) else (0 < a) and ((-1 - tmin) < (a - 1)) else @import("std").zig.c_translation.MacroArithmetic.div(tmin, b) < a else if (b == 0) 0 else if (a < 0) if ((_GL_INT_NEGATE_OVERFLOW(_GL_INT_CONVERT(a, tmin)) != 0) and (a == -1)) if (_GL_EXPR_SIGNED(b)) 0 < (b + tmin) else (-1 - tmin) < (b - 1) else @import("std").zig.c_translation.MacroArithmetic.div(tmin, a) < b else @import("std").zig.c_translation.MacroArithmetic.div(tmax, b) < a;
}
pub const TYPE_IS_INTEGER = @compileError("unable to translate C expr: expected ')' instead got 'A number'");
// lib/intprops.h:28:9
pub inline fn TYPE_SIGNED(t: anytype) @TypeOf(_GL_TYPE_SIGNED(t)) {
    return _GL_TYPE_SIGNED(t);
}
pub inline fn EXPR_SIGNED(e: anytype) @TypeOf(_GL_EXPR_SIGNED(e)) {
    return _GL_EXPR_SIGNED(e);
}
pub inline fn TYPE_WIDTH(t: anytype) @TypeOf(_GL_TYPE_WIDTH(t)) {
    return _GL_TYPE_WIDTH(t);
}
pub const TYPE_MINIMUM = @compileError("unable to translate C expr: expected ')' instead got '~'");
// lib/intprops.h:46:9
pub const TYPE_MAXIMUM = @compileError("unable to translate C expr: expected ')' instead got 'A number'");
// lib/intprops.h:47:9
pub inline fn INT_BITS_STRLEN_BOUND(b: anytype) @TypeOf(@import("std").zig.c_translation.MacroArithmetic.div((b * 146) + 484, 485)) {
    return @import("std").zig.c_translation.MacroArithmetic.div((b * 146) + 484, 485);
}
pub inline fn INT_STRLEN_BOUND(t: anytype) @TypeOf(INT_BITS_STRLEN_BOUND(TYPE_WIDTH(t) - _GL_SIGNED_TYPE_OR_EXPR(t)) + _GL_SIGNED_TYPE_OR_EXPR(t)) {
    return INT_BITS_STRLEN_BOUND(TYPE_WIDTH(t) - _GL_SIGNED_TYPE_OR_EXPR(t)) + _GL_SIGNED_TYPE_OR_EXPR(t);
}
pub inline fn INT_BUFSIZE_BOUND(t: anytype) @TypeOf(INT_STRLEN_BOUND(t) + 1) {
    return INT_STRLEN_BOUND(t) + 1;
}
pub inline fn INT_ADD_RANGE_OVERFLOW(a: anytype, b: anytype, min: anytype, max: anytype) @TypeOf(if (b < 0) a < (min - b) else (max - b) < a) {
    return if (b < 0) a < (min - b) else (max - b) < a;
}
pub inline fn INT_SUBTRACT_RANGE_OVERFLOW(a: anytype, b: anytype, min: anytype, max: anytype) @TypeOf(if (b < 0) (max + b) < a else a < (min + b)) {
    return if (b < 0) (max + b) < a else a < (min + b);
}
pub inline fn INT_NEGATE_RANGE_OVERFLOW(a: anytype, min: anytype, max: anytype) @TypeOf(_GL_INT_NEGATE_RANGE_OVERFLOW(a, min, max)) {
    return _GL_INT_NEGATE_RANGE_OVERFLOW(a, min, max);
}
pub inline fn INT_MULTIPLY_RANGE_OVERFLOW(a: anytype, b: anytype, min: anytype, max: anytype) @TypeOf(if (b < 0) if (a < 0) a < @import("std").zig.c_translation.MacroArithmetic.div(max, b) else if (b == -1) 0 else @import("std").zig.c_translation.MacroArithmetic.div(min, b) < a else if (b == 0) 0 else if (a < 0) a < @import("std").zig.c_translation.MacroArithmetic.div(min, b) else @import("std").zig.c_translation.MacroArithmetic.div(max, b) < a) {
    return if (b < 0) if (a < 0) a < @import("std").zig.c_translation.MacroArithmetic.div(max, b) else if (b == -1) 0 else @import("std").zig.c_translation.MacroArithmetic.div(min, b) < a else if (b == 0) 0 else if (a < 0) a < @import("std").zig.c_translation.MacroArithmetic.div(min, b) else @import("std").zig.c_translation.MacroArithmetic.div(max, b) < a;
}
pub inline fn INT_DIVIDE_RANGE_OVERFLOW(a: anytype, b: anytype, min: anytype, max: anytype) @TypeOf(((min < 0) and (b == -1)) and (a < -max)) {
    return ((min < 0) and (b == -1)) and (a < -max);
}
pub inline fn INT_REMAINDER_RANGE_OVERFLOW(a: anytype, b: anytype, min: anytype, max: anytype) @TypeOf(INT_DIVIDE_RANGE_OVERFLOW(a, b, min, max)) {
    return INT_DIVIDE_RANGE_OVERFLOW(a, b, min, max);
}
pub inline fn INT_LEFT_SHIFT_RANGE_OVERFLOW(a: anytype, b: anytype, min: anytype, max: anytype) @TypeOf(if (a < 0) a < (min >> b) else (max >> b) < a) {
    return if (a < 0) a < (min >> b) else (max >> b) < a;
}
pub inline fn _GL_ADD_OVERFLOW(a: anytype, b: anytype, min: anytype, max: anytype) @TypeOf(if (min < 0) INT_ADD_RANGE_OVERFLOW(a, b, min, max) else if (a < 0) b <= (a + b) else if (b < 0) a <= (a + b) else (a + b) < b) {
    return if (min < 0) INT_ADD_RANGE_OVERFLOW(a, b, min, max) else if (a < 0) b <= (a + b) else if (b < 0) a <= (a + b) else (a + b) < b;
}
pub inline fn _GL_SUBTRACT_OVERFLOW(a: anytype, b: anytype, min: anytype, max: anytype) @TypeOf(if (min < 0) INT_SUBTRACT_RANGE_OVERFLOW(a, b, min, max) else if (a < 0) 1 else if (b < 0) (a - b) <= a else a < b) {
    return if (min < 0) INT_SUBTRACT_RANGE_OVERFLOW(a, b, min, max) else if (a < 0) 1 else if (b < 0) (a - b) <= a else a < b;
}
pub inline fn _GL_MULTIPLY_OVERFLOW(a: anytype, b: anytype, min: anytype, max: anytype) @TypeOf(((min == 0) and (((a < 0) and (0 < b)) or ((b < 0) and (0 < a)))) or (INT_MULTIPLY_RANGE_OVERFLOW(a, b, min, max) != 0)) {
    return ((min == 0) and (((a < 0) and (0 < b)) or ((b < 0) and (0 < a)))) or (INT_MULTIPLY_RANGE_OVERFLOW(a, b, min, max) != 0);
}
pub inline fn _GL_DIVIDE_OVERFLOW(a: anytype, b: anytype, min: anytype, max: anytype) @TypeOf(if (min < 0) (b == _GL_INT_NEGATE_CONVERT(min, 1)) and (a < -max) else if (a < 0) b <= ((a + b) - 1) else (b < 0) and ((a + b) <= a)) {
    return if (min < 0) (b == _GL_INT_NEGATE_CONVERT(min, 1)) and (a < -max) else if (a < 0) b <= ((a + b) - 1) else (b < 0) and ((a + b) <= a);
}
pub inline fn _GL_REMAINDER_OVERFLOW(a: anytype, b: anytype, min: anytype, max: anytype) @TypeOf(if (min < 0) (b == _GL_INT_NEGATE_CONVERT(min, 1)) and (a < -max) else if (a < 0) @import("std").zig.c_translation.MacroArithmetic.rem(a, b) != @import("std").zig.c_translation.MacroArithmetic.rem((max - b) + 1, b) else (b < 0) and !(_GL_UNSIGNED_NEG_MULTIPLE(a, b, max) != 0)) {
    return if (min < 0) (b == _GL_INT_NEGATE_CONVERT(min, 1)) and (a < -max) else if (a < 0) @import("std").zig.c_translation.MacroArithmetic.rem(a, b) != @import("std").zig.c_translation.MacroArithmetic.rem((max - b) + 1, b) else (b < 0) and !(_GL_UNSIGNED_NEG_MULTIPLE(a, b, max) != 0);
}
pub inline fn _GL_UNSIGNED_NEG_MULTIPLE(a: anytype, b: anytype, max: anytype) @TypeOf((if (b < -_GL_SIGNED_INT_MAXIMUM(b)) if (_GL_SIGNED_INT_MAXIMUM(b) == max) a else @import("std").zig.c_translation.MacroArithmetic.rem(a, _GL_INT_CONVERT(a, _GL_SIGNED_INT_MAXIMUM(b)) + 1) else @import("std").zig.c_translation.MacroArithmetic.rem(a, -b)) == 0) {
    return (if (b < -_GL_SIGNED_INT_MAXIMUM(b)) if (_GL_SIGNED_INT_MAXIMUM(b) == max) a else @import("std").zig.c_translation.MacroArithmetic.rem(a, _GL_INT_CONVERT(a, _GL_SIGNED_INT_MAXIMUM(b)) + 1) else @import("std").zig.c_translation.MacroArithmetic.rem(a, -b)) == 0;
}
pub inline fn INT_ADD_OVERFLOW(a: anytype, b: anytype) @TypeOf(_GL_BINARY_OP_OVERFLOW(a, b, _GL_ADD_OVERFLOW)) {
    return _GL_BINARY_OP_OVERFLOW(a, b, _GL_ADD_OVERFLOW);
}
pub inline fn INT_SUBTRACT_OVERFLOW(a: anytype, b: anytype) @TypeOf(_GL_BINARY_OP_OVERFLOW(a, b, _GL_SUBTRACT_OVERFLOW)) {
    return _GL_BINARY_OP_OVERFLOW(a, b, _GL_SUBTRACT_OVERFLOW);
}
pub inline fn INT_NEGATE_OVERFLOW(a: anytype) @TypeOf(_GL_INT_NEGATE_OVERFLOW(a)) {
    return _GL_INT_NEGATE_OVERFLOW(a);
}
pub inline fn INT_MULTIPLY_OVERFLOW(a: anytype, b: anytype) @TypeOf(_GL_BINARY_OP_OVERFLOW(a, b, _GL_MULTIPLY_OVERFLOW)) {
    return _GL_BINARY_OP_OVERFLOW(a, b, _GL_MULTIPLY_OVERFLOW);
}
pub inline fn INT_DIVIDE_OVERFLOW(a: anytype, b: anytype) @TypeOf(_GL_BINARY_OP_OVERFLOW(a, b, _GL_DIVIDE_OVERFLOW)) {
    return _GL_BINARY_OP_OVERFLOW(a, b, _GL_DIVIDE_OVERFLOW);
}
pub inline fn INT_REMAINDER_OVERFLOW(a: anytype, b: anytype) @TypeOf(_GL_BINARY_OP_OVERFLOW(a, b, _GL_REMAINDER_OVERFLOW)) {
    return _GL_BINARY_OP_OVERFLOW(a, b, _GL_REMAINDER_OVERFLOW);
}
pub inline fn INT_LEFT_SHIFT_OVERFLOW(a: anytype, b: anytype) @TypeOf(INT_LEFT_SHIFT_RANGE_OVERFLOW(a, b, _GL_INT_MINIMUM(a), _GL_INT_MAXIMUM(a))) {
    return INT_LEFT_SHIFT_RANGE_OVERFLOW(a, b, _GL_INT_MINIMUM(a), _GL_INT_MAXIMUM(a));
}
pub inline fn _GL_BINARY_OP_OVERFLOW(a: anytype, b: anytype, op_result_overflow: anytype) @TypeOf(op_result_overflow(a, b, _GL_INT_MINIMUM(_GL_INT_CONVERT(a, b)), _GL_INT_MAXIMUM(_GL_INT_CONVERT(a, b)))) {
    return op_result_overflow(a, b, _GL_INT_MINIMUM(_GL_INT_CONVERT(a, b)), _GL_INT_MAXIMUM(_GL_INT_CONVERT(a, b)));
}
pub inline fn INT_ADD_WRAPV(a: anytype, b: anytype, r: anytype) @TypeOf(_GL_INT_ADD_WRAPV(a, b, r)) {
    return _GL_INT_ADD_WRAPV(a, b, r);
}
pub inline fn INT_SUBTRACT_WRAPV(a: anytype, b: anytype, r: anytype) @TypeOf(_GL_INT_SUBTRACT_WRAPV(a, b, r)) {
    return _GL_INT_SUBTRACT_WRAPV(a, b, r);
}
pub inline fn INT_MULTIPLY_WRAPV(a: anytype, b: anytype, r: anytype) @TypeOf(_GL_INT_MULTIPLY_WRAPV(a, b, r)) {
    return _GL_INT_MULTIPLY_WRAPV(a, b, r);
}
pub inline fn INT_ADD_OK(a: anytype, b: anytype, r: anytype) @TypeOf(!(INT_ADD_WRAPV(a, b, r) != 0)) {
    return !(INT_ADD_WRAPV(a, b, r) != 0);
}
pub inline fn INT_SUBTRACT_OK(a: anytype, b: anytype, r: anytype) @TypeOf(!(INT_SUBTRACT_WRAPV(a, b, r) != 0)) {
    return !(INT_SUBTRACT_WRAPV(a, b, r) != 0);
}
pub inline fn INT_MULTIPLY_OK(a: anytype, b: anytype, r: anytype) @TypeOf(!(INT_MULTIPLY_WRAPV(a, b, r) != 0)) {
    return !(INT_MULTIPLY_WRAPV(a, b, r) != 0);
}
