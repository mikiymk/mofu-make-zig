...
pub export fn load_file(arg_flocp: [*c]const floc, arg_file_1: ?*struct_file, arg_noerror: c_int) c_int {
    var flocp = arg_flocp;
    _ = &flocp;
    ...
    if ((file_1 != null) and (@as(c_int, @bitCast(file_1.*.loaded)) != 0)) return -@as(c_int, 1);
    if (!(symname != null)) {
        var p: [*c]u8 = new;
        _ = &p;
