...
const __dev_t = root.ctypes.__dev_t;
const __uid_t = root.ctypes.__uid_t;
const __gid_t = root.ctypes.__gid_t;
const __ino_t = root.ctypes.__ino_t;
const __ino64_t = root.ctypes.__ino64_t;
const __mode_t = root.ctypes.__mode_t;
const __nlink_t = root.ctypes.__nlink_t;
const __off_t = root.ctypes.__off_t;
const __blksize_t = root.ctypes.__blksize_t;
const __blkcnt_t = root.ctypes.__blkcnt_t;
const __blkcnt64_t = root.ctypes.__blkcnt64_t;
const __time_t = root.ctypes.__time_t;
const __syscall_slong_t = root.ctypes.__syscall_slong_t;
