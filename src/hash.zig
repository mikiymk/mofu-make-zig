...
pub const hash_func_t = *fn (key: *const void) c_ulong;
pub const hash_cmp_func_t = *fn (x: *const void, y: *const void) c_int;
...
pub const hash_table = struct {
    ...
    ht_hash_1: hash_func_t,
    /// secondary hash function
    ht_hash_2: hash_func_t,
    /// comparison function
    ht_compare: hash_cmp_func_t,
