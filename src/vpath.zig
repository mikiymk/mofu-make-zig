...
pub fn selective_vpath_search(arg_path: [*c]struct_vpath, arg_file_1: [*c]const u8, arg_mtime_ptr: [*c]uintmax_t, arg_path_index: [*c]c_uint) callconv(.C) [*c]const u8 {
    var path = arg_path;
    _ = &path;
    var file_1 = arg_file_1;
    _ = &file_1;
    ...
    _ = &exists;
    {
        var f: ?*struct_file = lookup_file(file_1);
        _ = &f;
    ...
    name = @as([*c]u8, @ptrCast(@alignCast(malloc(((((maxvpath +% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))) +% name_dplen) +% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))) +% flen) +% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))))));
    {
        ...
        while (vpath_2[i] != null) : (i +%= 1) {
            ...
            {
                var f: ?*struct_file = lookup_file(name);
                _ = &f;
                if (f != null) {
                    exists = @intFromBool((not_target != 0) or (@as(c_int, @bitCast(f.*.is_target)) != 0));
