...
const __suseconds_t = root.ctypes.__suseconds_t;
const __syscall_slong_t = root.ctypes.__syscall_slong_t;
const __clockid_t = root.ctypes.__clockid_t;
const time_t = root.ctypes.time_t;
const clock_t = root.ctypes.clock_t;
const locale_t = root.clocale.locale_t;
const clockid_t = root.ctypes.clockid_t;
const pid_t = root.ctypes.pid_t;
const timer_t = root.ctypes.timer_t;
const struct_sigevent = root.csignal.struct_sigevent;
