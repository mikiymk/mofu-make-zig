...
pub fn decode_env_switches(arg_envar: [*c]const u8, arg_len: usize, arg_origin: enum_variable_origin) callconv(.C) void {
    var envar = arg_envar;
    _ = &envar;
    var len = arg_len;
    _ = &len;
...
pub var goals: [*c]struct_goaldep = @import("std").mem.zeroes([*c]struct_goaldep);
pub var lastgoal: [*c]struct_goaldep = @import("std").mem.zeroes([*c]struct_goaldep);
...
pub fn handle_non_switch_argument(arg_arg: [*c]const u8, arg_origin: enum_variable_origin) callconv(.C) void {
    var arg = arg_arg;
    _ = &arg;
    var origin = arg_origin;
    _ = &origin;
