...
pub export fn reset_makeflags(arg_origin: enum_variable_origin) void {
    ...
    decode_env_switches("MAKEFLAGS", @sizeOf([10]u8) -% ulong, origin);
...
pub export fn should_print_dir() c_int {
    ...
    return @intFromBool(!(silent_flag != 0) and ((makelevel > uint) or (directories != @as([*c]struct_stringlist, @ptrFromInt(0)))));
}
...
pub fn clean_jobserver(arg_status: c_int) callconv(.C) void {
    ...
    if ((jobserver_enabled() != 0) and (jobserver_tokens != 0)) {
        if (status != 2) {
            c_error_fn_replaced_for_reserved_keyword(@ptrFromInt(0), ((ulong *% @sizeOf(uintmax_t)) / ulong) +% ulong, "INTERNAL: Exiting with %u jobserver tokens (should be 0)!", jobserver_tokens);
        } else while ((blk: {
    ...
    if (master_job_slots != 0) {
        var tokens: c_uint = uint +% jobserver_acquire_all();
        if (tokens != master_job_slots) {
            c_error_fn_replaced_for_reserved_keyword(@ptrFromInt(0), (((ulong *% @sizeOf(uintmax_t)) / ulong) +% ulong) *% ulong, "INTERNAL: Exiting with %u jobserver tokens available; should be %u!", tokens, master_job_slots);
        }
        reset_jobserver();
    }
}
...
pub fn print_data_base() callconv(.C) void {
    var when: time_t = time(@ptrFromInt(0));
    print_version();
...
pub fn print_version() callconv(.C) void {
    ...
    const precede: [*c]const u8 = if (print_data_base_flag != 0) "# " else "";
    ...
    while (optind < argc) {
        ...
        if (c == -1) break else if (c == 1) {
            ...
            while (cs.*.c != @as(c_int, '\x00')) : (cs += 1) if (cs.*.c == c) {
                var doit: c_int = @intFromBool((origin == @as(c_uint, @bitCast(o_command))) or ((@as(c_int, @bitCast(cs.*.env)) != 0) and ((cs.*.origin == @as([*c]enum_variable_origin, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(0)))))) or (origin >= cs.*.origin.*))));
                if (doit != 0) {
                    cs.*.specified = 1;
                }
                while (true) {
                    switch (cs.*.type) {
                        ...
                        uint, uint, uint => {
                            ...
                            if (!(coptarg != null)) {
                                ...
                                c_error_fn_replaced_for_reserved_keyword(@as([*c]floc, @ptrFromInt(0)), strlen(op), gettext("the '%s%s' option requires a non-empty string argument"), if (cs.*.c <= 127) "-" else "--", op);
                                bad = 1;
                                break;
                            }
                            ...
                            if (sl == null) {
                                ...
                                sl.*.max = 5;
                                sl.*.idx = 0;
                                sl.*.list = @as([*c][*c]const u8, @ptrCast(@alignCast(xmalloc(ulong *% @sizeOf([*c]u8)))));
                                @as([*c][*c]struct_stringlist, @ptrCast(@alignCast(cs.*.value_ptr))).* = sl;
                            } else if (sl.*.idx == (sl.*.max -% uint)) {
                                sl.*.max +%= uint;
                            ...
                            if (cs.*.c != @as(c_int, 'f')) {
                                ...
                                {
                                    k = 0;
                                    while (k < sl.*.idx) : (k +%= 1) if ((sl.*.list[k] == coptarg) or ((@as(c_int, @bitCast(@as(c_uint, sl.*.list[k].*))) == @as(c_int, @bitCast(@as(c_uint, coptarg.*)))) and ((@as(c_int, @bitCast(@as(c_uint, sl.*.list[k].*))) == @as(c_int, '\x00')) or !(strcmp(sl.*.list[k] + @as(usize, @bitCast(@as(isize, 1))), coptarg + @as(usize, @bitCast(@as(isize, 1)))) != 0)))) break;
                                }
                                if (k < sl.*.idx) break;
                            }
                        ...
                        uint => {
                            if ((coptarg == null) and (argc > optind)) {
                                var cp: [*c]const u8 = undefined;
                                {
                                    ...
                                    while ((@as(c_uint, @bitCast(@as(c_uint, cp[0]))) -% @as(c_uint, @bitCast(@as(c_int, '0')))) <= uint) : (cp += 1) {}
                                }
                            ...
                            if (coptarg != null) {
                                ...
                                if ((err != null) or (i == uint)) {
                                    c_error_fn_replaced_for_reserved_keyword(@as([*c]floc, @ptrFromInt(0)), @as(usize, 0), gettext("the '-%c' option requires a positive integer argument"), cs.*.c);
                                    bad = 1;
                                } else {
                        ...
                        uint => {
                            if (((coptarg == null) and (optind < argc)) and (((@as(c_uint, @bitCast(@as(c_uint, (blk: {
                                const tmp = optind;
                                if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                            }).*[0]))) -% @as(c_uint, @bitCast(@as(c_int, '0')))) <= uint) or (@as(c_int, @bitCast(@as(c_uint, (blk: {
                                const tmp = optind;
                                if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                            }).*[0]))) == @as(c_int, '.')))) {
                                coptarg = (blk: {
...
pub var print_directory_flag: c_int = -1;
pub const default_print_directory_flag: c_int = -1;
...
pub var arg_job_slots: c_int = -1;
pub const default_job_slots: c_int = -1;
...
pub fn bsd_signal(sig: c_int, func: bsd_signal_ret_t) callconv(.C) bsd_signal_ret_t {
    ...
    if (sigaction(sig, &act, &oact) != 0) {
        return @as(bsd_signal_ret_t, @ptrFromInt(-1));
    }
...
pub fn initialize_stopchar_map() callconv(.C) void {
    ...
    stopchar_map[@as(c_uint, @intCast(@as(c_int, '|')))] = @as(c_ushort, @bitCast(@as(c_short, @truncate(256))));
    stopchar_map[@as(c_uint, @intCast(@as(c_int, '.')))] = @as(c_ushort, @bitCast(@as(c_short, @truncate(512 | 8192))));
    stopchar_map[@as(c_uint, @intCast(@as(c_int, ',')))] = @as(c_ushort, @bitCast(@as(c_short, @truncate(1024))));
    stopchar_map[@as(c_uint, @intCast(@as(c_int, '(')))] = 128;
    stopchar_map[@as(c_uint, @intCast(@as(c_int, '{')))] = 128;
    stopchar_map[@as(c_uint, @intCast(@as(c_int, '}')))] = 128;
    stopchar_map[@as(c_uint, @intCast(@as(c_int, ')')))] = 128;
    stopchar_map[@as(c_uint, @intCast(@as(c_int, '$')))] = @as(c_ushort, @bitCast(@as(c_short, @truncate(16384))));
    stopchar_map[@as(c_uint, @intCast(@as(c_int, '-')))] = @as(c_ushort, @bitCast(@as(c_short, @truncate(8192))));
    stopchar_map[@as(c_uint, @intCast(@as(c_int, '_')))] = @as(c_ushort, @bitCast(@as(c_short, @truncate(8192))));
    stopchar_map[@as(c_uint, @intCast(@as(c_int, ' ')))] = 2;
    stopchar_map[@as(c_uint, @intCast(@as(c_int, '\t')))] = 2;
    stopchar_map[@as(c_uint, @intCast(@as(c_int, '/')))] = @as(c_ushort, @bitCast(@as(c_short, @truncate(32768))));
    {
        i = 1;
        while (i <= ((127 * 2) + 1)) : (i += 1) {
            if (((@as(c_int, @bitCast(@as(c_uint, (blk: {
                ...
                stopchar_map[@as(c_uint, @intCast(i))] |= @as(c_ushort, @bitCast(@as(c_short, @truncate(8192))));
            }
        }
    }
}
...
/// If/when we abandon the requirement to work with K&R compilers, we can remove this (and perhaps other parts of GNU Make!) and migrate to using gnulib directly.
///
/// This is called only through atexit(), which means die() has already been invoked.  So, call exit() here directly.  Apparently that works...?
///
///
...
///
/// Besides, it's wasteful to check the return value from every call that writes to stdout -- just let the internal stream state record the failure.  That's what the ferror test is checking below.
///
...
pub fn close_stdout() callconv(.C) void {
    const prev_fail = ferror(stdout);
    const fclose_fail = fclose(stdout);
    if ((prev_fail != 0) or (fclose_fail != 0)) {
        if (fclose_fail != 0) {
            perror_with_name(gettext("write error: stdout"), "");
        } else {
            c_error_fn_replaced_for_reserved_keyword(@as([*c]floc, @ptrFromInt(0)), @as(usize, 0), gettext("write error: stdout"));
        }
        exit(1);
    }
}
...
pub fn expand_command_line_file(arg_name: [*c]const u8) callconv(.C) [*c]const u8 {
    ...
    while ((@as(c_int, @bitCast(@as(c_uint, name[0]))) == @as(c_int, '.')) and (@as(c_int, @bitCast(@as(c_uint, name[1]))) == @as(c_int, '/'))) {
        name += @as(usize, @bitCast(@as(isize, 2)));
...
pub fn decode_output_sync_flags() callconv(.C) void {
    if (output_sync_option != null) {
        if ((output_sync_option == "none") or ((@as(c_int, @bitCast(@as(c_uint, output_sync_option.*))) == @as(c_int, @bitCast(@as(c_uint, "none".*)))) and ((@as(c_int, @bitCast(@as(c_uint, output_sync_option.*))) == @as(c_int, '\x00')) or !(strcmp(output_sync_option + @as(usize, @bitCast(@as(isize, 1))), "none" + @as(usize, @bitCast(@as(isize, 1)))) != 0)))) {
            output_sync = 0;
        } else if ((output_sync_option == "line") or ((@as(c_int, @bitCast(@as(c_uint, output_sync_option.*))) == @as(c_int, @bitCast(@as(c_uint, "line".*)))) and ((@as(c_int, @bitCast(@as(c_uint, output_sync_option.*))) == @as(c_int, '\x00')) or !(strcmp(output_sync_option + @as(usize, @bitCast(@as(isize, 1))), "line" + @as(usize, @bitCast(@as(isize, 1)))) != 0)))) {
            output_sync = 1;
        } else if ((output_sync_option == "target") or ((@as(c_int, @bitCast(@as(c_uint, output_sync_option.*))) == @as(c_int, @bitCast(@as(c_uint, "target".*)))) and ((@as(c_int, @bitCast(@as(c_uint, output_sync_option.*))) == @as(c_int, '\x00')) or !(strcmp(output_sync_option + @as(usize, @bitCast(@as(isize, 1))), "target" + @as(usize, @bitCast(@as(isize, 1)))) != 0)))) {
            output_sync = 2;
        } else if ((output_sync_option == "recurse") or ((@as(c_int, @bitCast(@as(c_uint, output_sync_option.*))) == @as(c_int, @bitCast(@as(c_uint, "recurse".*)))) and ((@as(c_int, @bitCast(@as(c_uint, output_sync_option.*))) == @as(c_int, '\x00')) or !(strcmp(output_sync_option + @as(usize, @bitCast(@as(isize, 1))), "recurse" + @as(usize, @bitCast(@as(isize, 1)))) != 0)))) {
            output_sync = 3;
        } else {
...
pub const INVALID_JOB_SLOTS = -1;
pub const TEMP_STDIN_OPT = CHAR_MAX + 10;
