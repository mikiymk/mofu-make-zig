...
pub export fn try_implicit_rule(arg_file_1: [*c]struct_file, arg_depth: c_uint) c_int {
...
pub const struct_patdeps = extern struct {
    name: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
...
// src/implicit.c:426:5: warning: TODO implement translation of stmt class GotoStmtClass

// src/implicit.c:210:1: warning: unable to translate function, demoted to extern
pub extern fn pattern_search(arg_file_1: [*c]struct_file, arg_archive: c_int, arg_depth: c_uint, arg_recursions: c_uint, arg_allow_compat_rules: c_int) callconv(.C) c_int;
