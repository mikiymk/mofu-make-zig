...
const __pid_t = root.ctypes.__pid_t;
const __uid_t = root.ctypes.__uid_t;
const __sig_atomic_t = root.ctypes.__sig_atomic_t;
const __clock_t = root.ctypes.__clock_t;
const __uint32_t = root.ctypes.__uint32_t;
const pthread_attr_t = root.cpthread.pthread_attr_t;
const struct_timespec = root.ctime.struct_timespec;
