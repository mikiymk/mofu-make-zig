...
export fn gmk_free(arg_s: [*c]u8) void {
    var s = arg_s;
    _ = &s;
    free(@as(?*anyopaque, @ptrCast(s)));
}
export fn gmk_alloc(arg_len: c_uint) [*c]u8 {
    var len = arg_len;
    _ = &len;
    return @as([*c]u8, @ptrCast(@alignCast(xmalloc(@as(usize, @bitCast(@as(c_ulong, len)))))));
}
export fn gmk_eval(arg_buffer: [*c]const u8, arg_gfloc: [*c]const gmk_floc) void {
...
const struct___va_list_tag_32 = extern struct {
    gp_offset: c_uint = @import("std").mem.zeroes(c_uint),
    fp_offset: c_uint = @import("std").mem.zeroes(c_uint),
    overflow_arg_area: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    reg_save_area: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
const __builtin_va_list = [1]struct___va_list_tag_32;
...
extern fn vfprintf(__s: [*c]FILE, __format: [*c]const u8, __arg: [*c]struct___va_list_tag_32) c_int;
extern fn vprintf(__format: [*c]const u8, __arg: [*c]struct___va_list_tag_32) c_int;
extern fn vsprintf(__s: [*c]u8, __format: [*c]const u8, __arg: [*c]struct___va_list_tag_32) c_int;
extern fn snprintf(__s: [*c]u8, __maxlen: c_ulong, __format: [*c]const u8, ...) c_int;
extern fn vsnprintf(__s: [*c]u8, __maxlen: c_ulong, __format: [*c]const u8, __arg: [*c]struct___va_list_tag_32) c_int;
extern fn vasprintf(noalias __ptr: [*c][*c]u8, noalias __f: [*c]const u8, __arg: [*c]struct___va_list_tag_32) c_int;
...
extern fn vdprintf(__fd: c_int, noalias __fmt: [*c]const u8, __arg: [*c]struct___va_list_tag_32) c_int;
...
extern fn vfscanf(noalias __s: [*c]FILE, noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_32) c_int;
extern fn vscanf(noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_32) c_int;
extern fn vsscanf(noalias __s: [*c]const u8, noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_32) c_int;
...
extern fn obstack_vprintf(noalias __obstack: ?*struct_obstack, noalias __format: [*c]const u8, __args: [*c]struct___va_list_tag_32) c_int;
...
const struct___locale_data_35 = opaque {};
...
const struct_dirent64_37 = opaque {};
...
extern fn set_command_state(file: [*c]struct_file, state: enum_cmd_state_2) void;
...
extern fn update_goal_chain(goals: [*c]struct_goaldep) enum_update_status_1;
