...
extern fn _dl_mcount_wrapper_check(__selfpc: ?*anyopaque) void;
const Lmid_t = c_long;
...
extern fn dlmopen(__nsid: Lmid_t, __file: [*c]const u8, __mode: c_int) ?*anyopaque;
extern fn dlvsym(noalias __handle: ?*anyopaque, noalias __name: [*c]const u8, noalias __version: [*c]const u8) ?*anyopaque;
...
extern fn dladdr(__address: ?*const anyopaque, __info: [*c]Dl_info) c_int;
extern fn dladdr1(__address: ?*const anyopaque, __info: [*c]Dl_info, __extra_info: [*c]?*anyopaque, __flags: c_int) c_int;
const RTLD_DL_SYMENT: c_int = 1;
const RTLD_DL_LINKMAP: c_int = 2;
const enum_unnamed_38 = c_uint;
extern fn dlinfo(noalias __handle: ?*anyopaque, __request: c_int, noalias __arg: ?*anyopaque) c_int;
const RTLD_DI_LMID: c_int = 1;
const RTLD_DI_LINKMAP: c_int = 2;
const RTLD_DI_CONFIGADDR: c_int = 3;
const RTLD_DI_SERINFO: c_int = 4;
const RTLD_DI_SERINFOSIZE: c_int = 5;
const RTLD_DI_ORIGIN: c_int = 6;
const RTLD_DI_PROFILENAME: c_int = 7;
const RTLD_DI_PROFILEOUT: c_int = 8;
const RTLD_DI_TLS_MODID: c_int = 9;
const RTLD_DI_TLS_DATA: c_int = 10;
const RTLD_DI_PHDR: c_int = 11;
const RTLD_DI_MAX: c_int = 11;
const enum_unnamed_39 = c_uint;
const Dl_serpath = extern struct {
...
const Dl_serinfo = extern struct {
...
const struct_link_map_41 = opaque {};
const struct_dl_find_object = extern struct {
...
extern fn _dl_find_object(__address: ?*anyopaque, __result: [*c]struct_dl_find_object) c_int;
...
extern fn expand_extra_prereqs(extra: [*c]const struct_variable) ?*struct_dep;
...
extern fn print_prereqs(deps: ?*const struct_dep) void;
