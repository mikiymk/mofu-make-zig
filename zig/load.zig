...
pub export fn load_file(arg_flocp: [*c]const floc, arg_file_1: [*c]struct_file, arg_noerror: c_int) c_int {
    var flocp = arg_flocp;
    _ = &flocp;
...
pub const struct_link_map_41 = opaque {};
pub const struct_dl_find_object = extern struct {
    ...
    dlfo_link_map: ?*struct_link_map_41 = @import("std").mem.zeroes(?*struct_link_map_41),
