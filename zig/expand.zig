...
pub export fn variable_expand_for_file(arg_line: [*c]const u8, arg_file_1: [*c]struct_file) [*c]u8 {
    var line = arg_line;
    _ = &line;
...
pub export fn allocated_variable_expand_for_file(arg_line: [*c]const u8, arg_file_1: [*c]struct_file) [*c]u8 {
    var line = arg_line;
    _ = &line;
    var file_1 = arg_file_1;
    _ = &file_1;
...
pub export fn expand_argument(arg_str: [*c]const u8, arg_end: [*c]const u8) [*c]u8 {
    var str = arg_str;
    _ = &str;
    var end = arg_end;
    _ = &end;
...
pub export fn variable_expand_string(arg_line: [*c]u8, arg_string: [*c]const u8, arg_length: usize) [*c]u8 {
    var line = arg_line;
    _ = &line;
    var string = arg_string;
    _ = &string;
...
pub export fn recursively_expand_for_file(arg_v: [*c]struct_variable, arg_file_1: [*c]struct_file) [*c]u8 {
    var v = arg_v;
    _ = &v;
    var file_1 = arg_file_1;
    _ = &file_1;
...
pub extern fn create_pattern_rule(targets: [*c][*c]const u8, target_percents: [*c][*c]const u8, num: c_ushort, terminal: c_int, deps: ?*struct_dep, commands: [*c]struct_commands, override: c_int) void;
...
pub fn allocated_variable_append(arg_v: [*c]const struct_variable) callconv(.C) [*c]u8 {
    var v = arg_v;
    _ = &v;
