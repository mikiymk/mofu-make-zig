...
extern fn load_file(flocp: [*c]const floc, file: ?*struct_file, noerror: c_int) c_int;
...
extern fn construct_command_argv(line: [*c]u8, restp: [*c][*c]u8, file: ?*struct_file, cmd_flags: c_int, batch_file: [*c][*c]u8) [*c][*c]u8;
