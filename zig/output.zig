...
pub inline fn FD_NOT_EMPTY(_f: anytype) @TypeOf((_f != OUTPUT_NONE) and (lseek(_f, @as(c_int, 0), SEEK_END) > @as(c_int, 0))) {
    _ = &_f;
    return (_f != OUTPUT_NONE) and (lseek(_f, @as(c_int, 0), SEEK_END) > @as(c_int, 0));
}
