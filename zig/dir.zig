...
pub const enum_update_status_34 = c_uint;
...
pub const enum_cmd_state_35 = c_uint;
...
pub export fn file_exists_p(arg_name: [*c]const u8) c_int {
    var name = arg_name;
    _ = &name;
...
pub export fn file_impossible_p(arg_filename: [*c]const u8) c_int {
    var filename = arg_filename;
    _ = &filename;
    var dirend: [*c]const u8 = undefined;
    _ = &dirend;
...
pub export fn file_impossible(arg_filename: [*c]const u8) void {
    var filename = arg_filename;
    _ = &filename;
    var dirend: [*c]const u8 = undefined;
    _ = &dirend;
...
pub extern fn set_command_state(file: [*c]struct_file, state: enum_cmd_state_35) void;
...
pub extern fn update_goal_chain(goals: [*c]struct_goaldep) enum_update_status_34;
...
pub inline fn MAKECMP(_x: anytype, _y: anytype) @TypeOf(if (_x < _y) -@as(c_int, 1) else if (_x == _y) @as(c_int, 0) else @as(c_int, 1)) {
    _ = &_x;
    _ = &_y;
    return if (_x < _y) -@as(c_int, 1) else if (_x == _y) @as(c_int, 0) else @as(c_int, 1);
}
