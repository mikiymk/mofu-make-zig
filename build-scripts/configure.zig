...
// # Generated by GNU Autoconf 2.69 for GNU Make 4.4.1.
// #
...
pub fn configure() !void {
    ...
    //   $as_echo "#define __STDC_WANT_IEC_60559_EXT__ 1" >>confdefs.h
    ...
    // $as_echo_n "checking for $CC option to enable large file support... " >&6; }
    // if ${ac_cv_sys_largefile_opts+:} false; then :
    //   $as_echo_n "(cached) " >&6
    // else
    //   ac_save_CC="$CC"
    //   ac_opt_found=no
    //   for ac_opt in "none needed" "-D_FILE_OFFSET_BITS=64" "-D_LARGE_FILES=1" "-n32"; do
    //     if test x"$ac_opt" != x"none needed"; then :
    ...
    // fi
    // { $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_cv_sys_largefile_opts" >&5
    // $as_echo "$ac_cv_sys_largefile_opts" >&6; }
    ...
    //   { $as_echo "$as_me:${as_lineno-$LINENO}: checking for $CC option to enable timestamps after Jan 2038" >&5
    // $as_echo_n "checking for $CC option to enable timestamps after Jan 2038... " >&6; }
    // if ${ac_cv_sys_year2038_opts+:} false; then :
    //   $as_echo_n "(cached) " >&6
    // else
    ...
    // fi
    // { $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_cv_sys_year2038_opts" >&5
    // $as_echo "$ac_cv_sys_year2038_opts" >&6; }
    ...
    //         if test $cross_compiling = no; then :
    //   if TZ=UTC0 touch -t 210602070628.15 conftest.time 2>/dev/null; then :
    ...
    //   { $as_echo "$as_me:${as_lineno-$LINENO}: checking if system libc has working GNU glob" >&5
    // $as_echo_n "checking if system libc has working GNU glob... " >&6; }
    ...
    // pkg_failed=no
    // { $as_echo "$as_me:${as_lineno-$LINENO}: checking for guile-$guile_version" >&5
    // $as_echo_n "checking for guile-$guile_version... " >&6; }
    ...
    // rm -f core conftest.err conftest.$ac_objext \
    //     conftest$ac_exeext conftest.$ac_ext
    //       { $as_echo "$as_me:${as_lineno-$LINENO}: result: $have_guile" >&5
    // $as_echo "$have_guile" >&6; }
    // fi
